...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	6b5040ef          	jal	ra,ffffffffc0204efe <memset>
...
ffffffffc0200056:	efe58593          	addi	a1,a1,-258 # ffffffffc0204f50 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	f1650513          	addi	a0,a0,-234 # ffffffffc0204f70 <etext+0x24>
...
ffffffffc020007a:	66a040ef          	jal	ra,ffffffffc02046e4 <proc_init>
...
ffffffffc020008e:	0a5040ef          	jal	ra,ffffffffc0204932 <cpu_idle>
...
ffffffffc02000ac:	ed050513          	addi	a0,a0,-304 # ffffffffc0204f78 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	18d040ef          	jal	ra,ffffffffc0204b00 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	157040ef          	jal	ra,ffffffffc0204b00 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	db650513          	addi	a0,a0,-586 # ffffffffc0204f80 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e4:	dc050513          	addi	a0,a0,-576 # ffffffffc0204fa0 <etext+0x54>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d6058593          	addi	a1,a1,-672 # ffffffffc0204f4c <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	dcc50513          	addi	a0,a0,-564 # ffffffffc0204fc0 <etext+0x74>
...
ffffffffc020020c:	dd850513          	addi	a0,a0,-552 # ffffffffc0204fe0 <etext+0x94>
...
ffffffffc0200220:	de450513          	addi	a0,a0,-540 # ffffffffc0205000 <etext+0xb4>
...
ffffffffc020024e:	dd650513          	addi	a0,a0,-554 # ffffffffc0205020 <etext+0xd4>
}
...
ffffffffc020025c:	df860613          	addi	a2,a2,-520 # ffffffffc0205050 <etext+0x104>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	e0450513          	addi	a0,a0,-508 # ffffffffc0205068 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200278:	e0c60613          	addi	a2,a2,-500 # ffffffffc0205080 <etext+0x134>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	e2458593          	addi	a1,a1,-476 # ffffffffc02050a0 <etext+0x154>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	e2450513          	addi	a0,a0,-476 # ffffffffc02050a8 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	e2660613          	addi	a2,a2,-474 # ffffffffc02050b8 <etext+0x16c>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e4658593          	addi	a1,a1,-442 # ffffffffc02050e0 <etext+0x194>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	e0650513          	addi	a0,a0,-506 # ffffffffc02050a8 <etext+0x15c>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e4260613          	addi	a2,a2,-446 # ffffffffc02050f0 <etext+0x1a4>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e5a58593          	addi	a1,a1,-422 # ffffffffc0205110 <etext+0x1c4>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dea50513          	addi	a0,a0,-534 # ffffffffc02050a8 <etext+0x15c>
...
ffffffffc02002fc:	e2850513          	addi	a0,a0,-472 # ffffffffc0205120 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e2e50513          	addi	a0,a0,-466 # ffffffffc0205148 <etext+0x1fc>
...
ffffffffc0200340:	e7cc0c13          	addi	s8,s8,-388 # ffffffffc02051b8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	e2c90913          	addi	s2,s2,-468 # ffffffffc0205170 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e2c48493          	addi	s1,s1,-468 # ffffffffc0205178 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e2ab0b13          	addi	s6,s6,-470 # ffffffffc0205180 <etext+0x234>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d42a0a13          	addi	s4,s4,-702 # ffffffffc02050a0 <etext+0x154>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	e38d0d13          	addi	s10,s10,-456 # ffffffffc02051b8 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	33d040ef          	jal	ra,ffffffffc0204eca <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	329040ef          	jal	ra,ffffffffc0204eca <strcmp>
...
ffffffffc02003e0:	309040ef          	jal	ra,ffffffffc0204ee8 <strchr>
...
ffffffffc020041e:	2cb040ef          	jal	ra,ffffffffc0204ee8 <strchr>
...
ffffffffc020043c:	d6850513          	addi	a0,a0,-664 # ffffffffc02051a0 <etext+0x254>
...
ffffffffc0200478:	d8c50513          	addi	a0,a0,-628 # ffffffffc0205200 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	ce650513          	addi	a0,a0,-794 # ffffffffc0206170 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	d5850513          	addi	a0,a0,-680 # ffffffffc0205220 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	185040ef          	jal	ra,ffffffffc0204f10 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	161040ef          	jal	ra,ffffffffc0204f10 <memcpy>
    return 0;
}
...
ffffffffc02005fe:	c4650513          	addi	a0,a0,-954 # ffffffffc0205240 <commands+0x88>
...
ffffffffc0200626:	c3e60613          	addi	a2,a2,-962 # ffffffffc0205260 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	c4a50513          	addi	a0,a0,-950 # ffffffffc0205278 <commands+0xc0>
...
ffffffffc0200660:	c3450513          	addi	a0,a0,-972 # ffffffffc0205290 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	c3c50513          	addi	a0,a0,-964 # ffffffffc02052a8 <commands+0xf0>
...
ffffffffc020067e:	c4650513          	addi	a0,a0,-954 # ffffffffc02052c0 <commands+0x108>
...
ffffffffc020068c:	c5050513          	addi	a0,a0,-944 # ffffffffc02052d8 <commands+0x120>
...
ffffffffc020069a:	c5a50513          	addi	a0,a0,-934 # ffffffffc02052f0 <commands+0x138>
...
ffffffffc02006a8:	c6450513          	addi	a0,a0,-924 # ffffffffc0205308 <commands+0x150>
...
ffffffffc02006b6:	c6e50513          	addi	a0,a0,-914 # ffffffffc0205320 <commands+0x168>
...
ffffffffc02006c4:	c7850513          	addi	a0,a0,-904 # ffffffffc0205338 <commands+0x180>
...
ffffffffc02006d2:	c8250513          	addi	a0,a0,-894 # ffffffffc0205350 <commands+0x198>
...
ffffffffc02006e0:	c8c50513          	addi	a0,a0,-884 # ffffffffc0205368 <commands+0x1b0>
...
ffffffffc02006ee:	c9650513          	addi	a0,a0,-874 # ffffffffc0205380 <commands+0x1c8>
...
ffffffffc02006fc:	ca050513          	addi	a0,a0,-864 # ffffffffc0205398 <commands+0x1e0>
...
ffffffffc020070a:	caa50513          	addi	a0,a0,-854 # ffffffffc02053b0 <commands+0x1f8>
...
ffffffffc0200718:	cb450513          	addi	a0,a0,-844 # ffffffffc02053c8 <commands+0x210>
...
ffffffffc0200726:	cbe50513          	addi	a0,a0,-834 # ffffffffc02053e0 <commands+0x228>
...
ffffffffc0200734:	cc850513          	addi	a0,a0,-824 # ffffffffc02053f8 <commands+0x240>
...
ffffffffc0200742:	cd250513          	addi	a0,a0,-814 # ffffffffc0205410 <commands+0x258>
...
ffffffffc0200750:	cdc50513          	addi	a0,a0,-804 # ffffffffc0205428 <commands+0x270>
...
ffffffffc020075e:	ce650513          	addi	a0,a0,-794 # ffffffffc0205440 <commands+0x288>
...
ffffffffc020076c:	cf050513          	addi	a0,a0,-784 # ffffffffc0205458 <commands+0x2a0>
...
ffffffffc020077a:	cfa50513          	addi	a0,a0,-774 # ffffffffc0205470 <commands+0x2b8>
...
ffffffffc0200788:	d0450513          	addi	a0,a0,-764 # ffffffffc0205488 <commands+0x2d0>
...
ffffffffc0200796:	d0e50513          	addi	a0,a0,-754 # ffffffffc02054a0 <commands+0x2e8>
...
ffffffffc02007a4:	d1850513          	addi	a0,a0,-744 # ffffffffc02054b8 <commands+0x300>
...
ffffffffc02007b2:	d2250513          	addi	a0,a0,-734 # ffffffffc02054d0 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	d2c50513          	addi	a0,a0,-724 # ffffffffc02054e8 <commands+0x330>
...
ffffffffc02007ce:	d3650513          	addi	a0,a0,-714 # ffffffffc0205500 <commands+0x348>
...
ffffffffc02007dc:	d4050513          	addi	a0,a0,-704 # ffffffffc0205518 <commands+0x360>
...
ffffffffc02007ea:	d4a50513          	addi	a0,a0,-694 # ffffffffc0205530 <commands+0x378>
...
ffffffffc02007f8:	d5450513          	addi	a0,a0,-684 # ffffffffc0205548 <commands+0x390>
...
ffffffffc0200806:	d5e50513          	addi	a0,a0,-674 # ffffffffc0205560 <commands+0x3a8>
...
ffffffffc0200818:	d6450513          	addi	a0,a0,-668 # ffffffffc0205578 <commands+0x3c0>
}
...
ffffffffc020082c:	d6850513          	addi	a0,a0,-664 # ffffffffc0205590 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	d6850513          	addi	a0,a0,-664 # ffffffffc02055a8 <commands+0x3f0>
...
ffffffffc0200854:	d7050513          	addi	a0,a0,-656 # ffffffffc02055c0 <commands+0x408>
...
ffffffffc0200864:	d7850513          	addi	a0,a0,-648 # ffffffffc02055d8 <commands+0x420>
...
ffffffffc0200878:	d7c50513          	addi	a0,a0,-644 # ffffffffc02055f0 <commands+0x438>
}
...
ffffffffc0200894:	e2870713          	addi	a4,a4,-472 # ffffffffc02056b8 <commands+0x500>
...
ffffffffc02008a6:	dc650513          	addi	a0,a0,-570 # ffffffffc0205668 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d9a50513          	addi	a0,a0,-614 # ffffffffc0205648 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	d4e50513          	addi	a0,a0,-690 # ffffffffc0205608 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	d6250513          	addi	a0,a0,-670 # ffffffffc0205628 <commands+0x470>
...
ffffffffc02008fc:	da050513          	addi	a0,a0,-608 # ffffffffc0205698 <commands+0x4e0>
...
ffffffffc0200910:	d7c50513          	addi	a0,a0,-644 # ffffffffc0205688 <commands+0x4d0>
}
...
ffffffffc0200932:	f7270713          	addi	a4,a4,-142 # ffffffffc02058a0 <commands+0x6e8>
...
ffffffffc0200944:	f4850513          	addi	a0,a0,-184 # ffffffffc0205888 <commands+0x6d0>
...
ffffffffc0200966:	d8650513          	addi	a0,a0,-634 # ffffffffc02056e8 <commands+0x530>
}
...
ffffffffc02009c0:	dcc60613          	addi	a2,a2,-564 # ffffffffc0205788 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	8b050513          	addi	a0,a0,-1872 # ffffffffc0205278 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	dd450513          	addi	a0,a0,-556 # ffffffffc02057a8 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	de250513          	addi	a0,a0,-542 # ffffffffc02057c0 <commands+0x608>
...
ffffffffc0200a6a:	d2260613          	addi	a2,a2,-734 # ffffffffc0205788 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00005517          	auipc	a0,0x5
ffffffffc0200a76:	80650513          	addi	a0,a0,-2042 # ffffffffc0205278 <commands+0xc0>
...
ffffffffc0200a96:	cf660613          	addi	a2,a2,-778 # ffffffffc0205788 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	7da50513          	addi	a0,a0,2010 # ffffffffc0205278 <commands+0xc0>
...
ffffffffc0200c2e:	44e63603          	ld	a2,1102(a2) # ffffffffc0207078 <nbase>
...
ffffffffc0200e74:	a7068693          	addi	a3,a3,-1424 # ffffffffc02058e0 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a7860613          	addi	a2,a2,-1416 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a8450513          	addi	a0,a0,-1404 # ffffffffc0205908 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	b1068693          	addi	a3,a3,-1264 # ffffffffc02059a0 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	a5860613          	addi	a2,a2,-1448 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	a6450513          	addi	a0,a0,-1436 # ffffffffc0205908 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	b1868693          	addi	a3,a3,-1256 # ffffffffc02059c8 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	a3860613          	addi	a2,a2,-1480 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	a4450513          	addi	a0,a0,-1468 # ffffffffc0205908 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	b3868693          	addi	a3,a3,-1224 # ffffffffc0205a08 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	a1860613          	addi	a2,a2,-1512 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	a2450513          	addi	a0,a0,-1500 # ffffffffc0205908 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	ba068693          	addi	a3,a3,-1120 # ffffffffc0205a90 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	9f860613          	addi	a2,a2,-1544 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	a0450513          	addi	a0,a0,-1532 # ffffffffc0205908 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	a3068693          	addi	a3,a3,-1488 # ffffffffc0205940 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	9d860613          	addi	a2,a2,-1576 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	9e450513          	addi	a0,a0,-1564 # ffffffffc0205908 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	b5068693          	addi	a3,a3,-1200 # ffffffffc0205a80 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	9b860613          	addi	a2,a2,-1608 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	9c450513          	addi	a0,a0,-1596 # ffffffffc0205908 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	b1868693          	addi	a3,a3,-1256 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	99860613          	addi	a2,a2,-1640 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	9a450513          	addi	a0,a0,-1628 # ffffffffc0205908 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	ad868693          	addi	a3,a3,-1320 # ffffffffc0205a48 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	97860613          	addi	a2,a2,-1672 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	98450513          	addi	a0,a0,-1660 # ffffffffc0205908 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	b4868693          	addi	a3,a3,-1208 # ffffffffc0205ad8 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	95860613          	addi	a2,a2,-1704 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	96450513          	addi	a0,a0,-1692 # ffffffffc0205908 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	b1868693          	addi	a3,a3,-1256 # ffffffffc0205ac8 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	93860613          	addi	a2,a2,-1736 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	94450513          	addi	a0,a0,-1724 # ffffffffc0205908 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a9868693          	addi	a3,a3,-1384 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	91860613          	addi	a2,a2,-1768 # ffffffffc02058f0 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	92450513          	addi	a0,a0,-1756 # ffffffffc0205908 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	ab868693          	addi	a3,a3,-1352 # ffffffffc0205aa8 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	8f860613          	addi	a2,a2,-1800 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	90450513          	addi	a0,a0,-1788 # ffffffffc0205908 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	93068693          	addi	a3,a3,-1744 # ffffffffc0205940 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	8d860613          	addi	a2,a2,-1832 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	8e450513          	addi	a0,a0,-1820 # ffffffffc0205908 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	a3868693          	addi	a3,a3,-1480 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	8b860613          	addi	a2,a2,-1864 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	8c450513          	addi	a0,a0,-1852 # ffffffffc0205908 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	93068693          	addi	a3,a3,-1744 # ffffffffc0205980 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	89860613          	addi	a2,a2,-1896 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	8a450513          	addi	a0,a0,-1884 # ffffffffc0205908 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205960 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	87860613          	addi	a2,a2,-1928 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	88450513          	addi	a0,a0,-1916 # ffffffffc0205908 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	8f068693          	addi	a3,a3,-1808 # ffffffffc0205980 <commands+0x7c8>
ffffffffc0201098:	00005617          	auipc	a2,0x5
ffffffffc020109c:	85860613          	addi	a2,a2,-1960 # ffffffffc02058f0 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00005517          	auipc	a0,0x5
ffffffffc02010a8:	86450513          	addi	a0,a0,-1948 # ffffffffc0205908 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b7868693          	addi	a3,a3,-1160 # ffffffffc0205c28 <commands+0xa70>
ffffffffc02010b8:	00005617          	auipc	a2,0x5
ffffffffc02010bc:	83860613          	addi	a2,a2,-1992 # ffffffffc02058f0 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00005517          	auipc	a0,0x5
ffffffffc02010c8:	84450513          	addi	a0,a0,-1980 # ffffffffc0205908 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	9f868693          	addi	a3,a3,-1544 # ffffffffc0205ac8 <commands+0x910>
ffffffffc02010d8:	00005617          	auipc	a2,0x5
ffffffffc02010dc:	81860613          	addi	a2,a2,-2024 # ffffffffc02058f0 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00005517          	auipc	a0,0x5
ffffffffc02010e8:	82450513          	addi	a0,a0,-2012 # ffffffffc0205908 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	97868693          	addi	a3,a3,-1672 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	7f860613          	addi	a2,a2,2040 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00005517          	auipc	a0,0x5
ffffffffc0201108:	80450513          	addi	a0,a0,-2044 # ffffffffc0205908 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	91868693          	addi	a3,a3,-1768 # ffffffffc0205a28 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	7d860613          	addi	a2,a2,2008 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	7e450513          	addi	a0,a0,2020 # ffffffffc0205908 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	ab868693          	addi	a3,a3,-1352 # ffffffffc0205be8 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	7b860613          	addi	a2,a2,1976 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	7c450513          	addi	a0,a0,1988 # ffffffffc0205908 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a7868693          	addi	a3,a3,-1416 # ffffffffc0205bc8 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	79860613          	addi	a2,a2,1944 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	7a450513          	addi	a0,a0,1956 # ffffffffc0205908 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	a3068693          	addi	a3,a3,-1488 # ffffffffc0205ba0 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	77860613          	addi	a2,a2,1912 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	78450513          	addi	a0,a0,1924 # ffffffffc0205908 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	9e868693          	addi	a3,a3,-1560 # ffffffffc0205b78 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	75860613          	addi	a2,a2,1880 # ffffffffc02058f0 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	76450513          	addi	a0,a0,1892 # ffffffffc0205908 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	9b868693          	addi	a3,a3,-1608 # ffffffffc0205b68 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	73860613          	addi	a2,a2,1848 # ffffffffc02058f0 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	74450513          	addi	a0,a0,1860 # ffffffffc0205908 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	89868693          	addi	a3,a3,-1896 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	71860613          	addi	a2,a2,1816 # ffffffffc02058f0 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	72450513          	addi	a0,a0,1828 # ffffffffc0205908 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	95868693          	addi	a3,a3,-1704 # ffffffffc0205b48 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	6f860613          	addi	a2,a2,1784 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	70450513          	addi	a0,a0,1796 # ffffffffc0205908 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	90868693          	addi	a3,a3,-1784 # ffffffffc0205b18 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	6d860613          	addi	a2,a2,1752 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	6e450513          	addi	a0,a0,1764 # ffffffffc0205908 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	8d068693          	addi	a3,a3,-1840 # ffffffffc0205b00 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	6b860613          	addi	a2,a2,1720 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	6c450513          	addi	a0,a0,1732 # ffffffffc0205908 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00005697          	auipc	a3,0x5
ffffffffc0201254:	81868693          	addi	a3,a3,-2024 # ffffffffc0205a68 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	69860613          	addi	a2,a2,1688 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	6a450513          	addi	a0,a0,1700 # ffffffffc0205908 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	87868693          	addi	a3,a3,-1928 # ffffffffc0205ae8 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	67860613          	addi	a2,a2,1656 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	68450513          	addi	a0,a0,1668 # ffffffffc0205908 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	97868693          	addi	a3,a3,-1672 # ffffffffc0205c08 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	65860613          	addi	a2,a2,1624 # ffffffffc02058f0 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	66450513          	addi	a0,a0,1636 # ffffffffc0205908 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	98868693          	addi	a3,a3,-1656 # ffffffffc0205c38 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	63860613          	addi	a2,a2,1592 # ffffffffc02058f0 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	64450513          	addi	a0,a0,1604 # ffffffffc0205908 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	65068693          	addi	a3,a3,1616 # ffffffffc0205920 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	61860613          	addi	a2,a2,1560 # ffffffffc02058f0 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	62450513          	addi	a0,a0,1572 # ffffffffc0205908 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	67068693          	addi	a3,a3,1648 # ffffffffc0205960 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	5f860613          	addi	a2,a2,1528 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	60450513          	addi	a0,a0,1540 # ffffffffc0205908 <commands+0x750>
...
ffffffffc0201440:	81468693          	addi	a3,a3,-2028 # ffffffffc0205c50 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	4ac60613          	addi	a2,a2,1196 # ffffffffc02058f0 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	4b850513          	addi	a0,a0,1208 # ffffffffc0205908 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7ec68693          	addi	a3,a3,2028 # ffffffffc0205c48 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	48c60613          	addi	a2,a2,1164 # ffffffffc02058f0 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	49850513          	addi	a0,a0,1176 # ffffffffc0205908 <commands+0x750>
...
ffffffffc0201512:	73a68693          	addi	a3,a3,1850 # ffffffffc0205c48 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	3da60613          	addi	a2,a2,986 # ffffffffc02058f0 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	3e650513          	addi	a0,a0,998 # ffffffffc0205908 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	69868693          	addi	a3,a3,1688 # ffffffffc0205c78 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	30860613          	addi	a2,a2,776 # ffffffffc02058f0 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	31450513          	addi	a0,a0,788 # ffffffffc0205908 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	64868693          	addi	a3,a3,1608 # ffffffffc0205c48 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2e860613          	addi	a2,a2,744 # ffffffffc02058f0 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	2f450513          	addi	a0,a0,756 # ffffffffc0205908 <commands+0x750>
...
ffffffffc02016f4:	9886b683          	ld	a3,-1656(a3) # ffffffffc0207078 <nbase>
...
ffffffffc0201724:	5b860613          	addi	a2,a2,1464 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	5d450513          	addi	a0,a0,1492 # ffffffffc0205d00 <default_pmm_manager+0x60>
...
ffffffffc0201812:	50268693          	addi	a3,a3,1282 # ffffffffc0205d10 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	0da60613          	addi	a2,a2,218 # ffffffffc02058f0 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	50e50513          	addi	a0,a0,1294 # ffffffffc0205d30 <default_pmm_manager+0x90>
...
ffffffffc0201834:	51850513          	addi	a0,a0,1304 # ffffffffc0205d48 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	52050513          	addi	a0,a0,1312 # ffffffffc0205d60 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	71453503          	ld	a0,1812(a0) # ffffffffc0207078 <nbase>
...
ffffffffc02019c6:	3e660613          	addi	a2,a2,998 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	33250513          	addi	a0,a0,818 # ffffffffc0205d00 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	3a460613          	addi	a2,a2,932 # ffffffffc0205d80 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	31850513          	addi	a0,a0,792 # ffffffffc0205d00 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	3b260613          	addi	a2,a2,946 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	2fe50513          	addi	a0,a0,766 # ffffffffc0205d00 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	3b660613          	addi	a2,a2,950 # ffffffffc0205dc8 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	2e250513          	addi	a0,a0,738 # ffffffffc0205d00 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	340030ef          	jal	ra,ffffffffc0204efe <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	2ae030ef          	jal	ra,ffffffffc0204efe <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	03260613          	addi	a2,a2,50 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	13e50513          	addi	a0,a0,318 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	01a60613          	addi	a2,a2,26 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	12650513          	addi	a0,a0,294 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	00060613          	mv	a2,a2
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	10c50513          	addi	a0,a0,268 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	fe660613          	addi	a2,a2,-26 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	0f250513          	addi	a0,a0,242 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	db078793          	addi	a5,a5,-592 # ffffffffc0205ca0 <default_pmm_manager>
...
ffffffffc0201f02:	f0250513          	addi	a0,a0,-254 # ffffffffc0205e00 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	ecc50513          	addi	a0,a0,-308 # ffffffffc0205e18 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	ec450513          	addi	a0,a0,-316 # ffffffffc0205e30 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e8450513          	addi	a0,a0,-380 # ffffffffc0205e58 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e8050513          	addi	a0,a0,-384 # ffffffffc0205e70 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	ec850513          	addi	a0,a0,-312 # ffffffffc0206158 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f4a58593          	addi	a1,a1,-182 # ffffffffc0206290 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	367020ef          	jal	ra,ffffffffc0204eb8 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	36d020ef          	jal	ra,ffffffffc0204eca <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2ef020ef          	jal	ra,ffffffffc0204e82 <strlen>
...
ffffffffc0202458:	eb450513          	addi	a0,a0,-332 # ffffffffc0206308 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c4a68693          	addi	a3,a3,-950 # ffffffffc02061b8 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	37a60613          	addi	a2,a2,890 # ffffffffc02058f0 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	86e50513          	addi	a0,a0,-1938 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	bea68693          	addi	a3,a3,-1046 # ffffffffc0206178 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	35a60613          	addi	a2,a2,858 # ffffffffc02058f0 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	84e50513          	addi	a0,a0,-1970 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	72860613          	addi	a2,a2,1832 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00004517          	auipc	a0,0x4
ffffffffc02025c0:	83450513          	addi	a0,a0,-1996 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	7b460613          	addi	a2,a2,1972 # ffffffffc0205d80 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00004517          	auipc	a0,0x4
ffffffffc02025dc:	81850513          	addi	a0,a0,-2024 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	79c60613          	addi	a2,a2,1948 # ffffffffc0205d80 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00004517          	auipc	a0,0x4
ffffffffc02025f4:	80050513          	addi	a0,a0,-2048 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	8b468693          	addi	a3,a3,-1868 # ffffffffc0205eb0 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2ec60613          	addi	a2,a2,748 # ffffffffc02058f0 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	7e050513          	addi	a0,a0,2016 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	87468693          	addi	a3,a3,-1932 # ffffffffc0205e90 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	2cc60613          	addi	a2,a2,716 # ffffffffc02058f0 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	7c050513          	addi	a0,a0,1984 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0202644:	90068693          	addi	a3,a3,-1792 # ffffffffc0205f40 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	2a860613          	addi	a2,a2,680 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	79c50513          	addi	a0,a0,1948 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	8b068693          	addi	a3,a3,-1872 # ffffffffc0205f10 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	28860613          	addi	a2,a2,648 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	77c50513          	addi	a0,a0,1916 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	86868693          	addi	a3,a3,-1944 # ffffffffc0205ee8 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	26860613          	addi	a2,a2,616 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	75c50513          	addi	a0,a0,1884 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	92868693          	addi	a3,a3,-1752 # ffffffffc0205fc8 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	24860613          	addi	a2,a2,584 # ffffffffc02058f0 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	73c50513          	addi	a0,a0,1852 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	9a868693          	addi	a3,a3,-1624 # ffffffffc0206068 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	22860613          	addi	a2,a2,552 # ffffffffc02058f0 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	71c50513          	addi	a0,a0,1820 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205fa0 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	20860613          	addi	a2,a2,520 # ffffffffc02058f0 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	6fc50513          	addi	a0,a0,1788 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0202706:	5d660613          	addi	a2,a2,1494 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	6e250513          	addi	a0,a0,1762 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	8e668693          	addi	a3,a3,-1818 # ffffffffc0206000 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	1ce60613          	addi	a2,a2,462 # ffffffffc02058f0 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	6c250513          	addi	a0,a0,1730 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	98e68693          	addi	a3,a3,-1650 # ffffffffc02060c8 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	1ae60613          	addi	a2,a2,430 # ffffffffc02058f0 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	6a250513          	addi	a0,a0,1698 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	95668693          	addi	a3,a3,-1706 # ffffffffc02060b0 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	18e60613          	addi	a2,a2,398 # ffffffffc02058f0 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	68250513          	addi	a0,a0,1666 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	90668693          	addi	a3,a3,-1786 # ffffffffc0206080 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	16e60613          	addi	a2,a2,366 # ffffffffc02058f0 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	66250513          	addi	a0,a0,1634 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a9e68693          	addi	a3,a3,-1378 # ffffffffc0206238 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	14e60613          	addi	a2,a2,334 # ffffffffc02058f0 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	64250513          	addi	a0,a0,1602 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	89668693          	addi	a3,a3,-1898 # ffffffffc0206050 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	12e60613          	addi	a2,a2,302 # ffffffffc02058f0 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	62250513          	addi	a0,a0,1570 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	86668693          	addi	a3,a3,-1946 # ffffffffc0206040 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	10e60613          	addi	a2,a2,270 # ffffffffc02058f0 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	60250513          	addi	a0,a0,1538 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	93e68693          	addi	a3,a3,-1730 # ffffffffc0206138 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0ee60613          	addi	a2,a2,238 # ffffffffc02058f0 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	5e250513          	addi	a0,a0,1506 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00004697          	auipc	a3,0x4
ffffffffc020281e:	81668693          	addi	a3,a3,-2026 # ffffffffc0206030 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	0ce60613          	addi	a2,a2,206 # ffffffffc02058f0 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	5c250513          	addi	a0,a0,1474 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	74e68693          	addi	a3,a3,1870 # ffffffffc0205f88 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	0ae60613          	addi	a2,a2,174 # ffffffffc02058f0 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	5a250513          	addi	a0,a0,1442 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	88668693          	addi	a3,a3,-1914 # ffffffffc02060e0 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	08e60613          	addi	a2,a2,142 # ffffffffc02058f0 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	58250513          	addi	a0,a0,1410 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	6f668693          	addi	a3,a3,1782 # ffffffffc0205f70 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	06e60613          	addi	a2,a2,110 # ffffffffc02058f0 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	56250513          	addi	a0,a0,1378 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	43e60613          	addi	a2,a2,1086 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	45a50513          	addi	a0,a0,1114 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	85e68693          	addi	a3,a3,-1954 # ffffffffc0206110 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	03660613          	addi	a2,a2,54 # ffffffffc02058f0 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	52a50513          	addi	a0,a0,1322 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	7f668693          	addi	a3,a3,2038 # ffffffffc02060c8 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	01660613          	addi	a2,a2,22 # ffffffffc02058f0 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	50a50513          	addi	a0,a0,1290 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00004697          	auipc	a3,0x4
ffffffffc02028f6:	80668693          	addi	a3,a3,-2042 # ffffffffc02060f8 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	ff660613          	addi	a2,a2,-10 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4ea50513          	addi	a0,a0,1258 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	7b668693          	addi	a3,a3,1974 # ffffffffc02060c8 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	fd660613          	addi	a2,a2,-42 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	4ca50513          	addi	a0,a0,1226 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8ee68693          	addi	a3,a3,-1810 # ffffffffc0206220 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	fb660613          	addi	a2,a2,-74 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	4aa50513          	addi	a0,a0,1194 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	89668693          	addi	a3,a3,-1898 # ffffffffc02061e8 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f9660613          	addi	a2,a2,-106 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	48a50513          	addi	a0,a0,1162 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	85e68693          	addi	a3,a3,-1954 # ffffffffc02061d0 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f7660613          	addi	a2,a2,-138 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	46a50513          	addi	a0,a0,1130 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	7a668693          	addi	a3,a3,1958 # ffffffffc0206138 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f5660613          	addi	a2,a2,-170 # ffffffffc02058f0 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	44a50513          	addi	a0,a0,1098 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	5be68693          	addi	a3,a3,1470 # ffffffffc0205f70 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	f3660613          	addi	a2,a2,-202 # ffffffffc02058f0 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	42a50513          	addi	a0,a0,1066 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	30660613          	addi	a2,a2,774 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	41250513          	addi	a0,a0,1042 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	59e68693          	addi	a3,a3,1438 # ffffffffc0205f88 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	efe60613          	addi	a2,a2,-258 # ffffffffc02058f0 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	3f250513          	addi	a0,a0,1010 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	5f668693          	addi	a3,a3,1526 # ffffffffc0206000 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	ede60613          	addi	a2,a2,-290 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	3d250513          	addi	a0,a0,978 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	8b668693          	addi	a3,a3,-1866 # ffffffffc02062e0 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	ebe60613          	addi	a2,a2,-322 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	3b250513          	addi	a0,a0,946 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	85e68693          	addi	a3,a3,-1954 # ffffffffc02062a8 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e9e60613          	addi	a2,a2,-354 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	39250513          	addi	a0,a0,914 # ffffffffc0205df0 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00004697          	auipc	a3,0x4
ffffffffc0202a6e:	80e68693          	addi	a3,a3,-2034 # ffffffffc0206278 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e7e60613          	addi	a2,a2,-386 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	37250513          	addi	a0,a0,882 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	83868693          	addi	a3,a3,-1992 # ffffffffc0206328 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	df860613          	addi	a2,a2,-520 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2ec50513          	addi	a0,a0,748 # ffffffffc0205df0 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	25e60613          	addi	a2,a2,606 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	1aa50513          	addi	a0,a0,426 # ffffffffc0205d00 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	562010ef          	jal	ra,ffffffffc02040e2 <swapfs_init>
...
ffffffffc0202bde:	79650513          	addi	a0,a0,1942 # ffffffffc0206370 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	75c50513          	addi	a0,a0,1884 # ffffffffc0206388 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	77850513          	addi	a0,a0,1912 # ffffffffc02063f8 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	7ac50513          	addi	a0,a0,1964 # ffffffffc0206448 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	7c050513          	addi	a0,a0,1984 # ffffffffc02064d0 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	25060613          	addi	a2,a2,592 # ffffffffc0207078 <nbase>
...
ffffffffc0202e58:	72450513          	addi	a0,a0,1828 # ffffffffc0206578 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	6a050513          	addi	a0,a0,1696 # ffffffffc02065c8 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	9a668693          	addi	a3,a3,-1626 # ffffffffc02058e0 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	9ae60613          	addi	a2,a2,-1618 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	41250513          	addi	a0,a0,1042 # ffffffffc0206360 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e4a60613          	addi	a2,a2,-438 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d9650513          	addi	a0,a0,-618 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	5da68693          	addi	a3,a3,1498 # ffffffffc0206550 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	97260613          	addi	a2,a2,-1678 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	3d650513          	addi	a0,a0,982 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	4da68693          	addi	a3,a3,1242 # ffffffffc0206470 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	95260613          	addi	a2,a2,-1710 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	3b650513          	addi	a0,a0,950 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	38a60613          	addi	a2,a2,906 # ffffffffc0206340 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	39e50513          	addi	a0,a0,926 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	56a68693          	addi	a3,a3,1386 # ffffffffc0206538 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	91a60613          	addi	a2,a2,-1766 # ffffffffc02058f0 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	37e50513          	addi	a0,a0,894 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	dda60613          	addi	a2,a2,-550 # ffffffffc0205dc8 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	d0650513          	addi	a0,a0,-762 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	48268693          	addi	a3,a3,1154 # ffffffffc0206488 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	8e260613          	addi	a2,a2,-1822 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	34650513          	addi	a0,a0,838 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	39a68693          	addi	a3,a3,922 # ffffffffc02063c0 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	8c260613          	addi	a2,a2,-1854 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	32650513          	addi	a0,a0,806 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	8da68693          	addi	a3,a3,-1830 # ffffffffc0205920 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	8a260613          	addi	a2,a2,-1886 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	30650513          	addi	a0,a0,774 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a6268693          	addi	a3,a3,-1438 # ffffffffc0205ac8 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	88260613          	addi	a2,a2,-1918 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	2e650513          	addi	a0,a0,742 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	35268693          	addi	a3,a3,850 # ffffffffc02063d8 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	86260613          	addi	a2,a2,-1950 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	2c650513          	addi	a0,a0,710 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	30a68693          	addi	a3,a3,778 # ffffffffc02063b0 <default_pmm_manager+0x710>
ffffffffc02030ae:	00003617          	auipc	a2,0x3
ffffffffc02030b2:	84260613          	addi	a2,a2,-1982 # ffffffffc02058f0 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	2a650513          	addi	a0,a0,678 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	4f268693          	addi	a3,a3,1266 # ffffffffc02065b8 <default_pmm_manager+0x918>
ffffffffc02030ce:	00003617          	auipc	a2,0x3
ffffffffc02030d2:	82260613          	addi	a2,a2,-2014 # ffffffffc02058f0 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	28650513          	addi	a0,a0,646 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	bf260613          	addi	a2,a2,-1038 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	c0e50513          	addi	a0,a0,-1010 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	4aa68693          	addi	a3,a3,1194 # ffffffffc02065a8 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7ea60613          	addi	a2,a2,2026 # ffffffffc02058f0 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	24e50513          	addi	a0,a0,590 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	3da68693          	addi	a3,a3,986 # ffffffffc02064f8 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	7ca60613          	addi	a2,a2,1994 # ffffffffc02058f0 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	22e50513          	addi	a0,a0,558 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	36a68693          	addi	a3,a3,874 # ffffffffc02064a8 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	7aa60613          	addi	a2,a2,1962 # ffffffffc02058f0 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	20e50513          	addi	a0,a0,526 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	2d268693          	addi	a3,a3,722 # ffffffffc0206430 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	78a60613          	addi	a2,a2,1930 # ffffffffc02058f0 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1ee50513          	addi	a0,a0,494 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	42268693          	addi	a3,a3,1058 # ffffffffc02065a0 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	76a60613          	addi	a2,a2,1898 # ffffffffc02058f0 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	1ce50513          	addi	a0,a0,462 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	24a68693          	addi	a3,a3,586 # ffffffffc02063e8 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	74a60613          	addi	a2,a2,1866 # ffffffffc02058f0 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	1ae50513          	addi	a0,a0,430 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	36a68693          	addi	a3,a3,874 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	72a60613          	addi	a2,a2,1834 # ffffffffc02058f0 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	18e50513          	addi	a0,a0,398 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	34a68693          	addi	a3,a3,842 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	70a60613          	addi	a2,a2,1802 # ffffffffc02058f0 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	16e50513          	addi	a0,a0,366 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	30a68693          	addi	a3,a3,778 # ffffffffc0206508 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6ea60613          	addi	a2,a2,1770 # ffffffffc02058f0 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	14e50513          	addi	a0,a0,334 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2ea68693          	addi	a3,a3,746 # ffffffffc0206508 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	6ca60613          	addi	a2,a2,1738 # ffffffffc02058f0 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	12e50513          	addi	a0,a0,302 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	2da68693          	addi	a3,a3,730 # ffffffffc0206518 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	6aa60613          	addi	a2,a2,1706 # ffffffffc02058f0 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	10e50513          	addi	a0,a0,270 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	2ba68693          	addi	a3,a3,698 # ffffffffc0206518 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	68a60613          	addi	a2,a2,1674 # ffffffffc02058f0 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0ee50513          	addi	a0,a0,238 # ffffffffc0206360 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	27a68693          	addi	a3,a3,634 # ffffffffc02064f8 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	66a60613          	addi	a2,a2,1642 # ffffffffc02058f0 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	0ce50513          	addi	a0,a0,206 # ffffffffc0206360 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	36ab0b13          	addi	s6,s6,874 # ffffffffc0206648 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	34ab8b93          	addi	s7,s7,842 # ffffffffc0206630 <default_pmm_manager+0x990>
...
ffffffffc020335a:	64f000ef          	jal	ra,ffffffffc02041a8 <swapfs_write>
...
ffffffffc020339c:	25050513          	addi	a0,a0,592 # ffffffffc02065e8 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	26e68693          	addi	a3,a3,622 # ffffffffc0206618 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	53e60613          	addi	a2,a2,1342 # ffffffffc02058f0 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	fa250513          	addi	a0,a0,-94 # ffffffffc0206360 <default_pmm_manager+0x6c0>
...
ffffffffc02033f8:	523000ef          	jal	ra,ffffffffc020411a <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02033fc:	00093583          	ld	a1,0(s2)
ffffffffc0203400:	8626                	mv	a2,s1
ffffffffc0203402:	00003517          	auipc	a0,0x3
ffffffffc0203406:	29650513          	addi	a0,a0,662 # ffffffffc0206698 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	26468693          	addi	a3,a3,612 # ffffffffc0206688 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	4c460613          	addi	a2,a2,1220 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	f2850513          	addi	a0,a0,-216 # ffffffffc0206360 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	27050513          	addi	a0,a0,624 # ffffffffc02066d8 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	27a50513          	addi	a0,a0,634 # ffffffffc0206718 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	27e50513          	addi	a0,a0,638 # ffffffffc0206740 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	28850513          	addi	a0,a0,648 # ffffffffc0206768 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	29450513          	addi	a0,a0,660 # ffffffffc0206790 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	24e50513          	addi	a0,a0,590 # ffffffffc0206768 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	1e650513          	addi	a0,a0,486 # ffffffffc0206718 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	21c50513          	addi	a0,a0,540 # ffffffffc0206768 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	17250513          	addi	a0,a0,370 # ffffffffc02066d8 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	1c050513          	addi	a0,a0,448 # ffffffffc0206740 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	1f650513          	addi	a0,a0,502 # ffffffffc0206790 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	16050513          	addi	a0,a0,352 # ffffffffc0206718 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	f3268693          	addi	a3,a3,-206 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	2f260613          	addi	a2,a2,754 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	0f650513          	addi	a0,a0,246 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	22a68693          	addi	a3,a3,554 # ffffffffc0206840 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	2d260613          	addi	a2,a2,722 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	0d650513          	addi	a0,a0,214 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	1e268693          	addi	a3,a3,482 # ffffffffc0206818 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	2b260613          	addi	a2,a2,690 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	0b650513          	addi	a0,a0,182 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	1b268693          	addi	a3,a3,434 # ffffffffc0206808 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	29260613          	addi	a2,a2,658 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	09650513          	addi	a0,a0,150 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	18268693          	addi	a3,a3,386 # ffffffffc02067f8 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	27260613          	addi	a2,a2,626 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	07650513          	addi	a0,a0,118 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	15268693          	addi	a3,a3,338 # ffffffffc02067e8 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	25260613          	addi	a2,a2,594 # ffffffffc02058f0 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	05650513          	addi	a0,a0,86 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	12268693          	addi	a3,a3,290 # ffffffffc02067d8 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	23260613          	addi	a2,a2,562 # ffffffffc02058f0 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	03650513          	addi	a0,a0,54 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	0f268693          	addi	a3,a3,242 # ffffffffc02067c8 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	21260613          	addi	a2,a2,530 # ffffffffc02058f0 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	01650513          	addi	a0,a0,22 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	0c268693          	addi	a3,a3,194 # ffffffffc02067b8 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	1f260613          	addi	a2,a2,498 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	ff650513          	addi	a0,a0,-10 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	0a268693          	addi	a3,a3,162 # ffffffffc02067b8 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	1d260613          	addi	a2,a2,466 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	fd650513          	addi	a0,a0,-42 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	df268693          	addi	a3,a3,-526 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	1b260613          	addi	a2,a2,434 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	fb650513          	addi	a0,a0,-74 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	dd268693          	addi	a3,a3,-558 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	19260613          	addi	a2,a2,402 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f9650513          	addi	a0,a0,-106 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	db268693          	addi	a3,a3,-590 # ffffffffc0206528 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	17260613          	addi	a2,a2,370 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f7650513          	addi	a0,a0,-138 # ffffffffc0206700 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	09868693          	addi	a3,a3,152 # ffffffffc0206850 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	13060613          	addi	a2,a2,304 # ffffffffc02058f0 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	f3450513          	addi	a0,a0,-204 # ffffffffc0206700 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	08868693          	addi	a3,a3,136 # ffffffffc0206860 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	11060613          	addi	a2,a2,272 # ffffffffc02058f0 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	f1450513          	addi	a0,a0,-236 # ffffffffc0206700 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	06068693          	addi	a3,a3,96 # ffffffffc0206870 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	0d860613          	addi	a2,a2,216 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	edc50513          	addi	a0,a0,-292 # ffffffffc0206700 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	07468693          	addi	a3,a3,116 # ffffffffc02068a8 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	0b460613          	addi	a2,a2,180 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	08050513          	addi	a0,a0,128 # ffffffffc02068c8 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	f5c68693          	addi	a3,a3,-164 # ffffffffc02068d8 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	f6c60613          	addi	a2,a2,-148 # ffffffffc02058f0 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	f3850513          	addi	a0,a0,-200 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f7c68693          	addi	a3,a3,-132 # ffffffffc0206918 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	f4c60613          	addi	a2,a2,-180 # ffffffffc02058f0 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	f1850513          	addi	a0,a0,-232 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	f3c68693          	addi	a3,a3,-196 # ffffffffc02068f8 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	f2c60613          	addi	a2,a2,-212 # ffffffffc02058f0 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	ef850513          	addi	a0,a0,-264 # ffffffffc02068c8 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	97a68693          	addi	a3,a3,-1670 # ffffffffc02063e8 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e7a60613          	addi	a2,a2,-390 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	e4650513          	addi	a0,a0,-442 # ffffffffc02068c8 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	92668693          	addi	a3,a3,-1754 # ffffffffc02063e8 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	e2660613          	addi	a2,a2,-474 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	df250513          	addi	a0,a0,-526 # ffffffffc02068c8 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	ea250513          	addi	a0,a0,-350 # ffffffffc0206a38 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	ebe68693          	addi	a3,a3,-322 # ffffffffc0206a60 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	d4660613          	addi	a2,a2,-698 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	d1250513          	addi	a0,a0,-750 # ffffffffc02068c8 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e9450513          	addi	a0,a0,-364 # ffffffffc0206a78 <default_pmm_manager+0xdd8>
...
ffffffffc0203cc2:	3baa3a03          	ld	s4,954(s4) # ffffffffc0207078 <nbase>
...
ffffffffc0203d7c:	d7850513          	addi	a0,a0,-648 # ffffffffc0206af0 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d7e50513          	addi	a0,a0,-642 # ffffffffc0206b10 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	baa68693          	addi	a3,a3,-1110 # ffffffffc0206950 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	b4260613          	addi	a2,a2,-1214 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	b0e50513          	addi	a0,a0,-1266 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	c1268693          	addi	a3,a3,-1006 # ffffffffc02069d8 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	b2260613          	addi	a2,a2,-1246 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	aee50513          	addi	a0,a0,-1298 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	c2268693          	addi	a3,a3,-990 # ffffffffc0206a08 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	b0260613          	addi	a2,a2,-1278 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	ace50513          	addi	a0,a0,-1330 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	b3268693          	addi	a3,a3,-1230 # ffffffffc0206938 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	ae260613          	addi	a2,a2,-1310 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	aae50513          	addi	a0,a0,-1362 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b9268693          	addi	a3,a3,-1134 # ffffffffc02069b8 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	ac260613          	addi	a2,a2,-1342 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a8e50513          	addi	a0,a0,-1394 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b8268693          	addi	a3,a3,-1150 # ffffffffc02069c8 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	aa260613          	addi	a2,a2,-1374 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	a6e50513          	addi	a0,a0,-1426 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	b2268693          	addi	a3,a3,-1246 # ffffffffc0206988 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a8260613          	addi	a2,a2,-1406 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	a4e50513          	addi	a0,a0,-1458 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	b1268693          	addi	a3,a3,-1262 # ffffffffc0206998 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	a6260613          	addi	a2,a2,-1438 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	a2e50513          	addi	a0,a0,-1490 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	b0268693          	addi	a3,a3,-1278 # ffffffffc02069a8 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	a4260613          	addi	a2,a2,-1470 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	a0e50513          	addi	a0,a0,-1522 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	c6268693          	addi	a3,a3,-926 # ffffffffc0206b28 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	a2260613          	addi	a2,a2,-1502 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	9ee50513          	addi	a0,a0,-1554 # ffffffffc02068c8 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	4fa68693          	addi	a3,a3,1274 # ffffffffc02063e8 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	9fa60613          	addi	a2,a2,-1542 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	9c650513          	addi	a0,a0,-1594 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b8a68693          	addi	a3,a3,-1142 # ffffffffc0206a98 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	9da60613          	addi	a2,a2,-1574 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	9a650513          	addi	a0,a0,-1626 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b8a68693          	addi	a3,a3,-1142 # ffffffffc0206ab8 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	9ba60613          	addi	a2,a2,-1606 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	98650513          	addi	a0,a0,-1658 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	e5a60613          	addi	a2,a2,-422 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	da650513          	addi	a0,a0,-602 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d7260613          	addi	a2,a2,-654 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d8e50513          	addi	a0,a0,-626 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206ac8 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	96a60613          	addi	a2,a2,-1686 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	93650513          	addi	a0,a0,-1738 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	43a68693          	addi	a3,a3,1082 # ffffffffc02063d8 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	94a60613          	addi	a2,a2,-1718 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	91650513          	addi	a0,a0,-1770 # ffffffffc02068c8 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	3f268693          	addi	a3,a3,1010 # ffffffffc02063b0 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	92a60613          	addi	a2,a2,-1750 # ffffffffc02058f0 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	8f650513          	addi	a0,a0,-1802 # ffffffffc02068c8 <default_pmm_manager+0xc28>
...
ffffffffc0204022:	c945                	beqz	a0,ffffffffc02040d2 <do_pgfault+0xf4>
...
ffffffffc0204084:	b1050513          	addi	a0,a0,-1264 # ffffffffc0206b90 <default_pmm_manager+0xef0>
...
ffffffffc0204096:	aae50513          	addi	a0,a0,-1362 # ffffffffc0206b40 <default_pmm_manager+0xea0>
...
ffffffffc02040a6:	b5e50513          	addi	a0,a0,-1186 # ffffffffc0206c00 <default_pmm_manager+0xf60>
...
ffffffffc02040b6:	b0650513          	addi	a0,a0,-1274 # ffffffffc0206bb8 <default_pmm_manager+0xf18>
ffffffffc02040ba:	8c6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040be:	5971                	li	s2,-4
ffffffffc02040c0:	b745                	j	ffffffffc0204060 <do_pgfault+0x82>
                cprintf("page_insert in do_pgfault failed\n");
ffffffffc02040c2:	00003517          	auipc	a0,0x3
ffffffffc02040c6:	b1650513          	addi	a0,a0,-1258 # ffffffffc0206bd8 <default_pmm_manager+0xf38>
ffffffffc02040ca:	8b6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040ce:	5971                	li	s2,-4
ffffffffc02040d0:	bf41                	j	ffffffffc0204060 <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040d2:	00003517          	auipc	a0,0x3
ffffffffc02040d6:	a9e50513          	addi	a0,a0,-1378 # ffffffffc0206b70 <default_pmm_manager+0xed0>
ffffffffc02040da:	8a6fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040de:	5971                	li	s2,-4
        goto failed;
ffffffffc02040e0:	b741                	j	ffffffffc0204060 <do_pgfault+0x82>

ffffffffc02040e2 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
swapfs_init(void) {
ffffffffc02040e6:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040e8:	c80fc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040ec:	cd01                	beqz	a0,ffffffffc0204104 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040ee:	4505                	li	a0,1
ffffffffc02040f0:	c7efc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc02040f4:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040f6:	810d                	srli	a0,a0,0x3
ffffffffc02040f8:	00012797          	auipc	a5,0x12
ffffffffc02040fc:	48a7b823          	sd	a0,1168(a5) # ffffffffc0216588 <max_swap_offset>
}
ffffffffc0204100:	0141                	addi	sp,sp,16
ffffffffc0204102:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204104:	00003617          	auipc	a2,0x3
ffffffffc0204108:	b2460613          	addi	a2,a2,-1244 # ffffffffc0206c28 <default_pmm_manager+0xf88>
ffffffffc020410c:	45b5                	li	a1,13
ffffffffc020410e:	00003517          	auipc	a0,0x3
ffffffffc0204112:	b3a50513          	addi	a0,a0,-1222 # ffffffffc0206c48 <default_pmm_manager+0xfa8>
ffffffffc0204116:	b30fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc020411a <swapfs_read>:
...
ffffffffc0204122:	cbb1                	beqz	a5,ffffffffc0204176 <swapfs_read+0x5c>
ffffffffc0204124:	00012717          	auipc	a4,0x12
ffffffffc0204128:	46473703          	ld	a4,1124(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc020412c:	04e7f563          	bgeu	a5,a4,ffffffffc0204176 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc0204130:	00012617          	auipc	a2,0x12
ffffffffc0204134:	44063603          	ld	a2,1088(a2) # ffffffffc0216570 <pages>
ffffffffc0204138:	8d91                	sub	a1,a1,a2
ffffffffc020413a:	4065d613          	srai	a2,a1,0x6
ffffffffc020413e:	00003717          	auipc	a4,0x3
ffffffffc0204142:	f3a73703          	ld	a4,-198(a4) # ffffffffc0207078 <nbase>
ffffffffc0204146:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204148:	00c61713          	slli	a4,a2,0xc
ffffffffc020414c:	8331                	srli	a4,a4,0xc
ffffffffc020414e:	00012697          	auipc	a3,0x12
ffffffffc0204152:	41a6b683          	ld	a3,1050(a3) # ffffffffc0216568 <npage>
ffffffffc0204156:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc020415a:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc020415c:	02d77963          	bgeu	a4,a3,ffffffffc020418e <swapfs_read+0x74>
}
ffffffffc0204160:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204162:	00012797          	auipc	a5,0x12
ffffffffc0204166:	41e7b783          	ld	a5,1054(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc020416a:	46a1                	li	a3,8
ffffffffc020416c:	963e                	add	a2,a2,a5
ffffffffc020416e:	4505                	li	a0,1
}
ffffffffc0204170:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204172:	c02fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204176:	86aa                	mv	a3,a0
ffffffffc0204178:	00003617          	auipc	a2,0x3
ffffffffc020417c:	ae860613          	addi	a2,a2,-1304 # ffffffffc0206c60 <default_pmm_manager+0xfc0>
ffffffffc0204180:	45d1                	li	a1,20
ffffffffc0204182:	00003517          	auipc	a0,0x3
ffffffffc0204186:	ac650513          	addi	a0,a0,-1338 # ffffffffc0206c48 <default_pmm_manager+0xfa8>
ffffffffc020418a:	abcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020418e:	86b2                	mv	a3,a2
ffffffffc0204190:	06900593          	li	a1,105
ffffffffc0204194:	00002617          	auipc	a2,0x2
ffffffffc0204198:	b4460613          	addi	a2,a2,-1212 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc020419c:	00002517          	auipc	a0,0x2
ffffffffc02041a0:	b6450513          	addi	a0,a0,-1180 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc02041a4:	aa2fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02041a8 <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc02041a8:	1141                	addi	sp,sp,-16
ffffffffc02041aa:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ac:	00855793          	srli	a5,a0,0x8
ffffffffc02041b0:	cbb1                	beqz	a5,ffffffffc0204204 <swapfs_write+0x5c>
ffffffffc02041b2:	00012717          	auipc	a4,0x12
ffffffffc02041b6:	3d673703          	ld	a4,982(a4) # ffffffffc0216588 <max_swap_offset>
ffffffffc02041ba:	04e7f563          	bgeu	a5,a4,ffffffffc0204204 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041be:	00012617          	auipc	a2,0x12
ffffffffc02041c2:	3b263603          	ld	a2,946(a2) # ffffffffc0216570 <pages>
ffffffffc02041c6:	8d91                	sub	a1,a1,a2
ffffffffc02041c8:	4065d613          	srai	a2,a1,0x6
ffffffffc02041cc:	00003717          	auipc	a4,0x3
ffffffffc02041d0:	eac73703          	ld	a4,-340(a4) # ffffffffc0207078 <nbase>
ffffffffc02041d4:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041d6:	00c61713          	slli	a4,a2,0xc
ffffffffc02041da:	8331                	srli	a4,a4,0xc
ffffffffc02041dc:	00012697          	auipc	a3,0x12
ffffffffc02041e0:	38c6b683          	ld	a3,908(a3) # ffffffffc0216568 <npage>
ffffffffc02041e4:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041e8:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041ea:	02d77963          	bgeu	a4,a3,ffffffffc020421c <swapfs_write+0x74>
}
ffffffffc02041ee:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041f0:	00012797          	auipc	a5,0x12
ffffffffc02041f4:	3907b783          	ld	a5,912(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02041f8:	46a1                	li	a3,8
ffffffffc02041fa:	963e                	add	a2,a2,a5
ffffffffc02041fc:	4505                	li	a0,1
}
ffffffffc02041fe:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204200:	b98fc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc0204204:	86aa                	mv	a3,a0
ffffffffc0204206:	00003617          	auipc	a2,0x3
ffffffffc020420a:	a5a60613          	addi	a2,a2,-1446 # ffffffffc0206c60 <default_pmm_manager+0xfc0>
ffffffffc020420e:	45e5                	li	a1,25
ffffffffc0204210:	00003517          	auipc	a0,0x3
ffffffffc0204214:	a3850513          	addi	a0,a0,-1480 # ffffffffc0206c48 <default_pmm_manager+0xfa8>
ffffffffc0204218:	a2efc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020421c:	86b2                	mv	a3,a2
ffffffffc020421e:	06900593          	li	a1,105
ffffffffc0204222:	00002617          	auipc	a2,0x2
ffffffffc0204226:	ab660613          	addi	a2,a2,-1354 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc020422a:	00002517          	auipc	a0,0x2
ffffffffc020422e:	ad650513          	addi	a0,a0,-1322 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0204232:	a14fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204236 <kernel_thread_entry>:
.text
.globl kernel_thread_entry
kernel_thread_entry:        # void kernel_thread(void)
	move a0, s1
ffffffffc0204236:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204238:	9402                	jalr	s0

	jal do_exit
ffffffffc020423a:	48e000ef          	jal	ra,ffffffffc02046c8 <do_exit>
...
ffffffffc0204246:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204248:	e06fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020424c:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc020424e:	c521                	beqz	a0,ffffffffc0204296 <alloc_proc+0x58>
...
ffffffffc0204250:	57fd                	li	a5,-1
ffffffffc0204252:	1782                	slli	a5,a5,0x20
ffffffffc0204254:	e11c                	sd	a5,0(a0)
    	proc->runs = 0;
    	proc->kstack = NULL;
    	proc->need_resched = 0;
        proc->parent = NULL;
...
ffffffffc0204256:	07000613          	li	a2,112
ffffffffc020425a:	4581                	li	a1,0
    	proc->runs = 0;
ffffffffc020425c:	00052423          	sw	zero,8(a0)
    	proc->kstack = NULL;
ffffffffc0204260:	00053823          	sd	zero,16(a0)
    	proc->need_resched = 0;
ffffffffc0204264:	00052c23          	sw	zero,24(a0)
        proc->parent = NULL;
ffffffffc0204268:	02053023          	sd	zero,32(a0)
        proc->mm = NULL;
ffffffffc020426c:	02053423          	sd	zero,40(a0)
        memset(&(proc->context), 0, sizeof(struct context));
ffffffffc0204270:	03050513          	addi	a0,a0,48
ffffffffc0204274:	48b000ef          	jal	ra,ffffffffc0204efe <memset>
        proc->tf = NULL;
        proc->cr3 = boot_cr3;
ffffffffc0204278:	00012797          	auipc	a5,0x12
ffffffffc020427c:	2e07b783          	ld	a5,736(a5) # ffffffffc0216558 <boot_cr3>
        proc->tf = NULL;
ffffffffc0204280:	0a043023          	sd	zero,160(s0)
        proc->cr3 = boot_cr3;
ffffffffc0204284:	f45c                	sd	a5,168(s0)
        proc->flags = 0;
ffffffffc0204286:	0a042823          	sw	zero,176(s0)
        memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc020428a:	463d                	li	a2,15
ffffffffc020428c:	4581                	li	a1,0
ffffffffc020428e:	0b440513          	addi	a0,s0,180
ffffffffc0204292:	46d000ef          	jal	ra,ffffffffc0204efe <memset>
...
forkret(void) {
    forkrets(current->tf);
ffffffffc02042a0:	00012797          	auipc	a5,0x12
ffffffffc02042a4:	3107b783          	ld	a5,784(a5) # ffffffffc02165b0 <current>
ffffffffc02042a8:	73c8                	ld	a0,160(a5)
ffffffffc02042aa:	8c3fc06f          	j	ffffffffc0200b6c <forkrets>

ffffffffc02042ae <init_main>:
    panic("process exit!!.\n");
}
...
ffffffffc02042b0:	ec26                	sd	s1,24(sp)
    memset(name, 0, sizeof(name));
ffffffffc02042b2:	00012497          	auipc	s1,0x12
ffffffffc02042b6:	26648493          	addi	s1,s1,614 # ffffffffc0216518 <name.2>
init_main(void *arg) {
ffffffffc02042ba:	f022                	sd	s0,32(sp)
ffffffffc02042bc:	e84a                	sd	s2,16(sp)
ffffffffc02042be:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042c0:	00012917          	auipc	s2,0x12
ffffffffc02042c4:	2f093903          	ld	s2,752(s2) # ffffffffc02165b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc02042d0:	e44e                	sd	s3,8(sp)
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042d2:	00492983          	lw	s3,4(s2)
    memset(name, 0, sizeof(name));
ffffffffc02042d6:	429000ef          	jal	ra,ffffffffc0204efe <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042da:	0b490593          	addi	a1,s2,180
ffffffffc02042de:	463d                	li	a2,15
ffffffffc02042e0:	8526                	mv	a0,s1
ffffffffc02042e2:	42f000ef          	jal	ra,ffffffffc0204f10 <memcpy>
ffffffffc02042e6:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042e8:	85ce                	mv	a1,s3
ffffffffc02042ea:	00003517          	auipc	a0,0x3
ffffffffc02042ee:	99650513          	addi	a0,a0,-1642 # ffffffffc0206c80 <default_pmm_manager+0xfe0>
ffffffffc02042f2:	e8ffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"%s\".\n", (const char *)arg);
ffffffffc02042f6:	85a2                	mv	a1,s0
ffffffffc02042f8:	00003517          	auipc	a0,0x3
ffffffffc02042fc:	9b050513          	addi	a0,a0,-1616 # ffffffffc0206ca8 <default_pmm_manager+0x1008>
ffffffffc0204300:	e81fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204304:	00003517          	auipc	a0,0x3
ffffffffc0204308:	9b450513          	addi	a0,a0,-1612 # ffffffffc0206cb8 <default_pmm_manager+0x1018>
ffffffffc020430c:	e75fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    return 0;
}
ffffffffc0204310:	70a2                	ld	ra,40(sp)
ffffffffc0204312:	7402                	ld	s0,32(sp)
ffffffffc0204314:	64e2                	ld	s1,24(sp)
ffffffffc0204316:	6942                	ld	s2,16(sp)
ffffffffc0204318:	69a2                	ld	s3,8(sp)
ffffffffc020431a:	4501                	li	a0,0
ffffffffc020431c:	6145                	addi	sp,sp,48
ffffffffc020431e:	8082                	ret

ffffffffc0204320 <proc_run>:
proc_run(struct proc_struct *proc) {
ffffffffc0204320:	7179                	addi	sp,sp,-48
ffffffffc0204322:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204324:	00012497          	auipc	s1,0x12
ffffffffc0204328:	28c48493          	addi	s1,s1,652 # ffffffffc02165b0 <current>
ffffffffc020432c:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc020432e:	f406                	sd	ra,40(sp)
ffffffffc0204330:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204332:	02a70863          	beq	a4,a0,ffffffffc0204362 <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204336:	100027f3          	csrr	a5,sstatus
ffffffffc020433a:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020433c:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020433e:	ef8d                	bnez	a5,ffffffffc0204378 <proc_run+0x58>
        lcr3(proc->cr3);    // 切换到下一个进程的页表
ffffffffc0204340:	755c                	ld	a5,168(a0)
...
ffffffffc0204342:	800006b7          	lui	a3,0x80000
        current = proc; // 将当前进程设置为下一个进程
ffffffffc0204346:	e088                	sd	a0,0(s1)
ffffffffc0204348:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc020434c:	8fd5                	or	a5,a5,a3
ffffffffc020434e:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(next->context));  // 进行上下文切换
ffffffffc0204352:	03050593          	addi	a1,a0,48
ffffffffc0204356:	03070513          	addi	a0,a4,48
ffffffffc020435a:	5f4000ef          	jal	ra,ffffffffc020494e <switch_to>
    if (flag) {
ffffffffc020435e:	00091763          	bnez	s2,ffffffffc020436c <proc_run+0x4c>
}
ffffffffc0204362:	70a2                	ld	ra,40(sp)
ffffffffc0204364:	7482                	ld	s1,32(sp)
ffffffffc0204366:	6962                	ld	s2,24(sp)
ffffffffc0204368:	6145                	addi	sp,sp,48
...
ffffffffc0204372:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204374:	a48fc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204378:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc020437a:	a48fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        struct proc_struct *prev = current; // 保存当前进程
ffffffffc020437e:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0204380:	6522                	ld	a0,8(sp)
ffffffffc0204382:	4905                	li	s2,1
ffffffffc0204384:	bf75                	j	ffffffffc0204340 <proc_run+0x20>

ffffffffc0204386 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204386:	7179                	addi	sp,sp,-48
ffffffffc0204388:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020438a:	00012497          	auipc	s1,0x12
ffffffffc020438e:	23e48493          	addi	s1,s1,574 # ffffffffc02165c8 <nr_process>
ffffffffc0204392:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204394:	f406                	sd	ra,40(sp)
ffffffffc0204396:	f022                	sd	s0,32(sp)
ffffffffc0204398:	e84a                	sd	s2,16(sp)
ffffffffc020439a:	e44e                	sd	s3,8(sp)
ffffffffc020439c:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020439e:	6785                	lui	a5,0x1
ffffffffc02043a0:	26f75163          	bge	a4,a5,ffffffffc0204602 <do_fork+0x27c>
ffffffffc02043a4:	892e                	mv	s2,a1
ffffffffc02043a6:	8432                	mv	s0,a2
    proc = alloc_proc();    // 调用alloc_proc函数分配一个proc_struct结构体
ffffffffc02043a8:	e97ff0ef          	jal	ra,ffffffffc020423e <alloc_proc>
ffffffffc02043ac:	89aa                	mv	s3,a0
    if (proc == NULL) { // 如果分配失败，返回错误码
ffffffffc02043ae:	24050f63          	beqz	a0,ffffffffc020460c <do_fork+0x286>
    proc->parent = current; // 设置父进程为当前进程
ffffffffc02043b2:	00012a17          	auipc	s4,0x12
ffffffffc02043b6:	1fea0a13          	addi	s4,s4,510 # ffffffffc02165b0 <current>
ffffffffc02043ba:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043be:	4509                	li	a0,2
    proc->parent = current; // 设置父进程为当前进程
ffffffffc02043c0:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043c4:	e68fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043c8:	1e050763          	beqz	a0,ffffffffc02045b6 <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043cc:	00012697          	auipc	a3,0x12
ffffffffc02043d0:	1a46b683          	ld	a3,420(a3) # ffffffffc0216570 <pages>
ffffffffc02043d4:	40d506b3          	sub	a3,a0,a3
ffffffffc02043d8:	8699                	srai	a3,a3,0x6
ffffffffc02043da:	00003517          	auipc	a0,0x3
ffffffffc02043de:	c9e53503          	ld	a0,-866(a0) # ffffffffc0207078 <nbase>
ffffffffc02043e2:	96aa                	add	a3,a3,a0
    return KADDR(page2pa(page));
ffffffffc02043e4:	00c69793          	slli	a5,a3,0xc
ffffffffc02043e8:	83b1                	srli	a5,a5,0xc
ffffffffc02043ea:	00012717          	auipc	a4,0x12
ffffffffc02043ee:	17e73703          	ld	a4,382(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043f2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043f4:	22e7fe63          	bgeu	a5,a4,ffffffffc0204630 <do_fork+0x2aa>
    assert(current->mm == NULL);
ffffffffc02043f8:	000a3783          	ld	a5,0(s4)
ffffffffc02043fc:	00012717          	auipc	a4,0x12
ffffffffc0204400:	18473703          	ld	a4,388(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc0204404:	96ba                	add	a3,a3,a4
ffffffffc0204406:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0204408:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc020440c:	20079263          	bnez	a5,ffffffffc0204610 <do_fork+0x28a>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204410:	6789                	lui	a5,0x2
ffffffffc0204412:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc0204416:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0204418:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc020441a:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc020441e:	87b6                	mv	a5,a3
ffffffffc0204420:	12040893          	addi	a7,s0,288
...
ffffffffc0204440:	ff1612e3          	bne	a2,a7,ffffffffc0204424 <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc0204444:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204448:	12090563          	beqz	s2,ffffffffc0204572 <do_fork+0x1ec>
...
ffffffffc0204454:	e5078793          	addi	a5,a5,-432 # ffffffffc02042a0 <forkret>
ffffffffc0204458:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020445c:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204460:	100027f3          	csrr	a5,sstatus
ffffffffc0204464:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204466:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204468:	12079663          	bnez	a5,ffffffffc0204594 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc020446c:	00007817          	auipc	a6,0x7
ffffffffc0204470:	bec80813          	addi	a6,a6,-1044 # ffffffffc020b058 <last_pid.1>
ffffffffc0204474:	00082783          	lw	a5,0(a6)
ffffffffc0204478:	6709                	lui	a4,0x2
ffffffffc020447a:	0017851b          	addiw	a0,a5,1
ffffffffc020447e:	00a82023          	sw	a0,0(a6)
ffffffffc0204482:	08e55163          	bge	a0,a4,ffffffffc0204504 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204486:	00007317          	auipc	t1,0x7
ffffffffc020448a:	bd630313          	addi	t1,t1,-1066 # ffffffffc020b05c <next_safe.0>
ffffffffc020448e:	00032783          	lw	a5,0(t1)
ffffffffc0204492:	00012417          	auipc	s0,0x12
ffffffffc0204496:	09640413          	addi	s0,s0,150 # ffffffffc0216528 <proc_list>
ffffffffc020449a:	06f55d63          	bge	a0,a5,ffffffffc0204514 <do_fork+0x18e>
    proc->pid = get_pid();  // 为子进程分配pid
ffffffffc020449e:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02044a2:	45a9                	li	a1,10
ffffffffc02044a4:	2501                	sext.w	a0,a0
ffffffffc02044a6:	5d8000ef          	jal	ra,ffffffffc0204a7e <hash32>
ffffffffc02044aa:	02051793          	slli	a5,a0,0x20
ffffffffc02044ae:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02044b2:	0000e797          	auipc	a5,0xe
ffffffffc02044b6:	06678793          	addi	a5,a5,102 # ffffffffc0212518 <hash_list>
ffffffffc02044ba:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044bc:	6510                	ld	a2,8(a0)
ffffffffc02044be:	0d898793          	addi	a5,s3,216
ffffffffc02044c2:	6414                	ld	a3,8(s0)
    nr_process++;
ffffffffc02044c4:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044c6:	e21c                	sd	a5,0(a2)
ffffffffc02044c8:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044ca:	0ec9b023          	sd	a2,224(s3)
    list_add(&proc_list, &(proc->list_link));   // 将子进程添加到proc_list中
ffffffffc02044ce:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044d2:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044d6:	e29c                	sd	a5,0(a3)
    nr_process++;
ffffffffc02044d8:	2705                	addiw	a4,a4,1
ffffffffc02044da:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044dc:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044e0:	0c89b423          	sd	s0,200(s3)
ffffffffc02044e4:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044e6:	0a091b63          	bnez	s2,ffffffffc020459c <do_fork+0x216>
    wakeup_proc(proc);  // 唤醒子进程
ffffffffc02044ea:	854e                	mv	a0,s3
ffffffffc02044ec:	4cc000ef          	jal	ra,ffffffffc02049b8 <wakeup_proc>
    ret = proc->pid;    // 设置返回值为子进程的pid
ffffffffc02044f0:	0049a503          	lw	a0,4(s3)
}
ffffffffc02044f4:	70a2                	ld	ra,40(sp)
ffffffffc02044f6:	7402                	ld	s0,32(sp)
ffffffffc02044f8:	64e2                	ld	s1,24(sp)
ffffffffc02044fa:	6942                	ld	s2,16(sp)
ffffffffc02044fc:	69a2                	ld	s3,8(sp)
ffffffffc02044fe:	6a02                	ld	s4,0(sp)
ffffffffc0204500:	6145                	addi	sp,sp,48
ffffffffc0204502:	8082                	ret
        last_pid = 1;
ffffffffc0204504:	4785                	li	a5,1
ffffffffc0204506:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc020450a:	4505                	li	a0,1
ffffffffc020450c:	00007317          	auipc	t1,0x7
ffffffffc0204510:	b5030313          	addi	t1,t1,-1200 # ffffffffc020b05c <next_safe.0>
    return listelm->next;
ffffffffc0204514:	00012417          	auipc	s0,0x12
ffffffffc0204518:	01440413          	addi	s0,s0,20 # ffffffffc0216528 <proc_list>
ffffffffc020451c:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204520:	6789                	lui	a5,0x2
ffffffffc0204522:	00f32023          	sw	a5,0(t1)
ffffffffc0204526:	86aa                	mv	a3,a0
ffffffffc0204528:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc020452a:	6e89                	lui	t4,0x2
ffffffffc020452c:	088e0063          	beq	t3,s0,ffffffffc02045ac <do_fork+0x226>
ffffffffc0204530:	88ae                	mv	a7,a1
ffffffffc0204532:	87f2                	mv	a5,t3
ffffffffc0204534:	6609                	lui	a2,0x2
ffffffffc0204536:	a811                	j	ffffffffc020454a <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204538:	00e6d663          	bge	a3,a4,ffffffffc0204544 <do_fork+0x1be>
ffffffffc020453c:	00c75463          	bge	a4,a2,ffffffffc0204544 <do_fork+0x1be>
ffffffffc0204540:	863a                	mv	a2,a4
ffffffffc0204542:	4885                	li	a7,1
ffffffffc0204544:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204546:	00878d63          	beq	a5,s0,ffffffffc0204560 <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc020454a:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020454e:	fed715e3          	bne	a4,a3,ffffffffc0204538 <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc0204552:	2685                	addiw	a3,a3,1
ffffffffc0204554:	04c6d763          	bge	a3,a2,ffffffffc02045a2 <do_fork+0x21c>
ffffffffc0204558:	679c                	ld	a5,8(a5)
ffffffffc020455a:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc020455c:	fe8797e3          	bne	a5,s0,ffffffffc020454a <do_fork+0x1c4>
ffffffffc0204560:	c581                	beqz	a1,ffffffffc0204568 <do_fork+0x1e2>
ffffffffc0204562:	00d82023          	sw	a3,0(a6)
ffffffffc0204566:	8536                	mv	a0,a3
ffffffffc0204568:	f2088be3          	beqz	a7,ffffffffc020449e <do_fork+0x118>
ffffffffc020456c:	00c32023          	sw	a2,0(t1)
ffffffffc0204570:	b73d                	j	ffffffffc020449e <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204572:	8936                	mv	s2,a3
ffffffffc0204574:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;  // 设置返回地址为forkret函数
ffffffffc0204578:	00000797          	auipc	a5,0x0
ffffffffc020457c:	d2878793          	addi	a5,a5,-728 # ffffffffc02042a0 <forkret>
ffffffffc0204580:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204584:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204588:	100027f3          	csrr	a5,sstatus
ffffffffc020458c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020458e:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204590:	ec078ee3          	beqz	a5,ffffffffc020446c <do_fork+0xe6>
        intr_disable();
ffffffffc0204594:	82efc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204598:	4905                	li	s2,1
ffffffffc020459a:	bdc9                	j	ffffffffc020446c <do_fork+0xe6>
        intr_enable();
ffffffffc020459c:	820fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc02045a0:	b7a9                	j	ffffffffc02044ea <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc02045a2:	01d6c363          	blt	a3,t4,ffffffffc02045a8 <do_fork+0x222>
                        last_pid = 1;
ffffffffc02045a6:	4685                	li	a3,1
                    goto repeat;
ffffffffc02045a8:	4585                	li	a1,1
ffffffffc02045aa:	b749                	j	ffffffffc020452c <do_fork+0x1a6>
ffffffffc02045ac:	cda9                	beqz	a1,ffffffffc0204606 <do_fork+0x280>
ffffffffc02045ae:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc02045b2:	8536                	mv	a0,a3
ffffffffc02045b4:	b5ed                	j	ffffffffc020449e <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045b6:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc02045ba:	c02007b7          	lui	a5,0xc0200
ffffffffc02045be:	0af6e163          	bltu	a3,a5,ffffffffc0204660 <do_fork+0x2da>
ffffffffc02045c2:	00012797          	auipc	a5,0x12
ffffffffc02045c6:	fbe7b783          	ld	a5,-66(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045ca:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045ce:	83b1                	srli	a5,a5,0xc
ffffffffc02045d0:	00012717          	auipc	a4,0x12
ffffffffc02045d4:	f9873703          	ld	a4,-104(a4) # ffffffffc0216568 <npage>
ffffffffc02045d8:	06e7f863          	bgeu	a5,a4,ffffffffc0204648 <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045dc:	00003717          	auipc	a4,0x3
ffffffffc02045e0:	a9c73703          	ld	a4,-1380(a4) # ffffffffc0207078 <nbase>
ffffffffc02045e4:	8f99                	sub	a5,a5,a4
ffffffffc02045e6:	079a                	slli	a5,a5,0x6
ffffffffc02045e8:	00012517          	auipc	a0,0x12
ffffffffc02045ec:	f8853503          	ld	a0,-120(a0) # ffffffffc0216570 <pages>
ffffffffc02045f0:	953e                	add	a0,a0,a5
ffffffffc02045f2:	4589                	li	a1,2
ffffffffc02045f4:	ccafd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045f8:	854e                	mv	a0,s3
ffffffffc02045fa:	b04fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045fe:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0204600:	bdd5                	j	ffffffffc02044f4 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204602:	556d                	li	a0,-5
ffffffffc0204604:	bdc5                	j	ffffffffc02044f4 <do_fork+0x16e>
    return last_pid;
ffffffffc0204606:	00082503          	lw	a0,0(a6)
ffffffffc020460a:	bd51                	j	ffffffffc020449e <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc020460c:	5571                	li	a0,-4
    return ret;
ffffffffc020460e:	b5dd                	j	ffffffffc02044f4 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc0204610:	00002697          	auipc	a3,0x2
ffffffffc0204614:	6c868693          	addi	a3,a3,1736 # ffffffffc0206cd8 <default_pmm_manager+0x1038>
ffffffffc0204618:	00001617          	auipc	a2,0x1
ffffffffc020461c:	2d860613          	addi	a2,a2,728 # ffffffffc02058f0 <commands+0x738>
ffffffffc0204620:	11a00593          	li	a1,282
ffffffffc0204624:	00002517          	auipc	a0,0x2
ffffffffc0204628:	6cc50513          	addi	a0,a0,1740 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
ffffffffc020462c:	e1bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0204630:	00001617          	auipc	a2,0x1
ffffffffc0204634:	6a860613          	addi	a2,a2,1704 # ffffffffc0205cd8 <default_pmm_manager+0x38>
ffffffffc0204638:	06900593          	li	a1,105
ffffffffc020463c:	00001517          	auipc	a0,0x1
ffffffffc0204640:	6c450513          	addi	a0,a0,1732 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0204644:	e03fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204648:	00001617          	auipc	a2,0x1
ffffffffc020464c:	76060613          	addi	a2,a2,1888 # ffffffffc0205da8 <default_pmm_manager+0x108>
ffffffffc0204650:	06200593          	li	a1,98
ffffffffc0204654:	00001517          	auipc	a0,0x1
ffffffffc0204658:	6ac50513          	addi	a0,a0,1708 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc020465c:	debfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0204660:	00001617          	auipc	a2,0x1
ffffffffc0204664:	72060613          	addi	a2,a2,1824 # ffffffffc0205d80 <default_pmm_manager+0xe0>
ffffffffc0204668:	06e00593          	li	a1,110
ffffffffc020466c:	00001517          	auipc	a0,0x1
ffffffffc0204670:	69450513          	addi	a0,a0,1684 # ffffffffc0205d00 <default_pmm_manager+0x60>
ffffffffc0204674:	dd3fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204678 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204678:	7129                	addi	sp,sp,-320
ffffffffc020467a:	fa22                	sd	s0,304(sp)
ffffffffc020467c:	f626                	sd	s1,296(sp)
ffffffffc020467e:	f24a                	sd	s2,288(sp)
ffffffffc0204680:	84ae                	mv	s1,a1
ffffffffc0204682:	892a                	mv	s2,a0
ffffffffc0204684:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204686:	4581                	li	a1,0
ffffffffc0204688:	12000613          	li	a2,288
ffffffffc020468c:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc020468e:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204690:	06f000ef          	jal	ra,ffffffffc0204efe <memset>
    tf.gpr.s0 = (uintptr_t)fn;// s0 寄存器保存函数指针
ffffffffc0204694:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;// s1 寄存器保存函数参数
ffffffffc0204696:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc0204698:	100027f3          	csrr	a5,sstatus
ffffffffc020469c:	edd7f793          	andi	a5,a5,-291
ffffffffc02046a0:	1207e793          	ori	a5,a5,288
ffffffffc02046a4:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046a6:	860a                	mv	a2,sp
ffffffffc02046a8:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046ac:	00000797          	auipc	a5,0x0
ffffffffc02046b0:	b8a78793          	addi	a5,a5,-1142 # ffffffffc0204236 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046b4:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02046b6:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02046b8:	ccfff0ef          	jal	ra,ffffffffc0204386 <do_fork>
}
ffffffffc02046bc:	70f2                	ld	ra,312(sp)
ffffffffc02046be:	7452                	ld	s0,304(sp)
ffffffffc02046c0:	74b2                	ld	s1,296(sp)
ffffffffc02046c2:	7912                	ld	s2,288(sp)
ffffffffc02046c4:	6131                	addi	sp,sp,320
ffffffffc02046c6:	8082                	ret

ffffffffc02046c8 <do_exit>:
do_exit(int error_code) {
ffffffffc02046c8:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02046ca:	00002617          	auipc	a2,0x2
ffffffffc02046ce:	63e60613          	addi	a2,a2,1598 # ffffffffc0206d08 <default_pmm_manager+0x1068>
ffffffffc02046d2:	18700593          	li	a1,391
ffffffffc02046d6:	00002517          	auipc	a0,0x2
ffffffffc02046da:	61a50513          	addi	a0,a0,1562 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
do_exit(int error_code) {
ffffffffc02046de:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046e0:	d67fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02046e4 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc02046e4:	7179                	addi	sp,sp,-48
ffffffffc02046e6:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046e8:	00012797          	auipc	a5,0x12
ffffffffc02046ec:	e4078793          	addi	a5,a5,-448 # ffffffffc0216528 <proc_list>
ffffffffc02046f0:	f406                	sd	ra,40(sp)
ffffffffc02046f2:	f022                	sd	s0,32(sp)
ffffffffc02046f4:	e84a                	sd	s2,16(sp)
ffffffffc02046f6:	e44e                	sd	s3,8(sp)
ffffffffc02046f8:	0000e497          	auipc	s1,0xe
ffffffffc02046fc:	e2048493          	addi	s1,s1,-480 # ffffffffc0212518 <hash_list>
...
ffffffffc0204704:	00012717          	auipc	a4,0x12
ffffffffc0204708:	e1470713          	addi	a4,a4,-492 # ffffffffc0216518 <name.2>
ffffffffc020470c:	87a6                	mv	a5,s1
ffffffffc020470e:	e79c                	sd	a5,8(a5)
ffffffffc0204710:	e39c                	sd	a5,0(a5)
ffffffffc0204712:	07c1                	addi	a5,a5,16
ffffffffc0204714:	fef71de3          	bne	a4,a5,ffffffffc020470e <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204718:	b27ff0ef          	jal	ra,ffffffffc020423e <alloc_proc>
ffffffffc020471c:	00012917          	auipc	s2,0x12
ffffffffc0204720:	e9c90913          	addi	s2,s2,-356 # ffffffffc02165b8 <idleproc>
ffffffffc0204724:	00a93023          	sd	a0,0(s2)
ffffffffc0204728:	18050d63          	beqz	a0,ffffffffc02048c2 <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020472c:	07000513          	li	a0,112
ffffffffc0204730:	91efd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204734:	07000613          	li	a2,112
ffffffffc0204738:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020473a:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020473c:	7c2000ef          	jal	ra,ffffffffc0204efe <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204740:	00093503          	ld	a0,0(s2)
ffffffffc0204744:	85a2                	mv	a1,s0
ffffffffc0204746:	07000613          	li	a2,112
ffffffffc020474a:	03050513          	addi	a0,a0,48
ffffffffc020474e:	7da000ef          	jal	ra,ffffffffc0204f28 <memcmp>
ffffffffc0204752:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204754:	453d                	li	a0,15
ffffffffc0204756:	8f8fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020475a:	463d                	li	a2,15
ffffffffc020475c:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020475e:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204760:	79e000ef          	jal	ra,ffffffffc0204efe <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204764:	00093503          	ld	a0,0(s2)
ffffffffc0204768:	463d                	li	a2,15
ffffffffc020476a:	85a2                	mv	a1,s0
ffffffffc020476c:	0b450513          	addi	a0,a0,180
ffffffffc0204770:	7b8000ef          	jal	ra,ffffffffc0204f28 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204774:	00093783          	ld	a5,0(s2)
ffffffffc0204778:	00012717          	auipc	a4,0x12
ffffffffc020477c:	de073703          	ld	a4,-544(a4) # ffffffffc0216558 <boot_cr3>
ffffffffc0204780:	77d4                	ld	a3,168(a5)
ffffffffc0204782:	0ee68463          	beq	a3,a4,ffffffffc020486a <proc_init+0x186>
...
ffffffffc0204786:	4709                	li	a4,2
ffffffffc0204788:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc020478a:	00004717          	auipc	a4,0x4
ffffffffc020478e:	87670713          	addi	a4,a4,-1930 # ffffffffc0208000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204792:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204796:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc0204798:	4705                	li	a4,1
ffffffffc020479a:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020479c:	4641                	li	a2,16
ffffffffc020479e:	4581                	li	a1,0
ffffffffc02047a0:	8522                	mv	a0,s0
ffffffffc02047a2:	75c000ef          	jal	ra,ffffffffc0204efe <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047a6:	463d                	li	a2,15
ffffffffc02047a8:	00002597          	auipc	a1,0x2
ffffffffc02047ac:	5a858593          	addi	a1,a1,1448 # ffffffffc0206d50 <default_pmm_manager+0x10b0>
ffffffffc02047b0:	8522                	mv	a0,s0
ffffffffc02047b2:	75e000ef          	jal	ra,ffffffffc0204f10 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02047b6:	00012717          	auipc	a4,0x12
ffffffffc02047ba:	e1270713          	addi	a4,a4,-494 # ffffffffc02165c8 <nr_process>
ffffffffc02047be:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02047c0:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047c4:	4601                	li	a2,0
    nr_process ++;
ffffffffc02047c6:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047c8:	00002597          	auipc	a1,0x2
ffffffffc02047cc:	59058593          	addi	a1,a1,1424 # ffffffffc0206d58 <default_pmm_manager+0x10b8>
ffffffffc02047d0:	00000517          	auipc	a0,0x0
ffffffffc02047d4:	ade50513          	addi	a0,a0,-1314 # ffffffffc02042ae <init_main>
    nr_process ++;
ffffffffc02047d8:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047da:	00012797          	auipc	a5,0x12
ffffffffc02047de:	dcd7bb23          	sd	a3,-554(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02047e2:	e97ff0ef          	jal	ra,ffffffffc0204678 <kernel_thread>
ffffffffc02047e6:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047e8:	0ea05963          	blez	a0,ffffffffc02048da <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047ec:	6789                	lui	a5,0x2
ffffffffc02047ee:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047f2:	17f9                	addi	a5,a5,-2
ffffffffc02047f4:	2501                	sext.w	a0,a0
ffffffffc02047f6:	02e7e363          	bltu	a5,a4,ffffffffc020481c <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047fa:	45a9                	li	a1,10
ffffffffc02047fc:	282000ef          	jal	ra,ffffffffc0204a7e <hash32>
ffffffffc0204800:	02051793          	slli	a5,a0,0x20
ffffffffc0204804:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204808:	96a6                	add	a3,a3,s1
ffffffffc020480a:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc020480c:	a029                	j	ffffffffc0204816 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc020480e:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0204812:	0a870563          	beq	a4,s0,ffffffffc02048bc <proc_init+0x1d8>
    return listelm->next;
ffffffffc0204816:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204818:	fef69be3          	bne	a3,a5,ffffffffc020480e <proc_init+0x12a>
    return NULL;
ffffffffc020481c:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020481e:	0b478493          	addi	s1,a5,180
ffffffffc0204822:	4641                	li	a2,16
ffffffffc0204824:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204826:	00012417          	auipc	s0,0x12
ffffffffc020482a:	d9a40413          	addi	s0,s0,-614 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020482e:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204830:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204832:	6cc000ef          	jal	ra,ffffffffc0204efe <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204836:	463d                	li	a2,15
ffffffffc0204838:	00002597          	auipc	a1,0x2
ffffffffc020483c:	55058593          	addi	a1,a1,1360 # ffffffffc0206d88 <default_pmm_manager+0x10e8>
ffffffffc0204840:	8526                	mv	a0,s1
ffffffffc0204842:	6ce000ef          	jal	ra,ffffffffc0204f10 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204846:	00093783          	ld	a5,0(s2)
ffffffffc020484a:	c7e1                	beqz	a5,ffffffffc0204912 <proc_init+0x22e>
ffffffffc020484c:	43dc                	lw	a5,4(a5)
ffffffffc020484e:	e3f1                	bnez	a5,ffffffffc0204912 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204850:	601c                	ld	a5,0(s0)
ffffffffc0204852:	c3c5                	beqz	a5,ffffffffc02048f2 <proc_init+0x20e>
ffffffffc0204854:	43d8                	lw	a4,4(a5)
ffffffffc0204856:	4785                	li	a5,1
ffffffffc0204858:	08f71d63          	bne	a4,a5,ffffffffc02048f2 <proc_init+0x20e>
}
ffffffffc020485c:	70a2                	ld	ra,40(sp)
ffffffffc020485e:	7402                	ld	s0,32(sp)
ffffffffc0204860:	64e2                	ld	s1,24(sp)
ffffffffc0204862:	6942                	ld	s2,16(sp)
ffffffffc0204864:	69a2                	ld	s3,8(sp)
ffffffffc0204866:	6145                	addi	sp,sp,48
ffffffffc0204868:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc020486a:	73d8                	ld	a4,160(a5)
ffffffffc020486c:	ff09                	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
ffffffffc020486e:	f0099ce3          	bnez	s3,ffffffffc0204786 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204872:	6394                	ld	a3,0(a5)
ffffffffc0204874:	577d                	li	a4,-1
ffffffffc0204876:	1702                	slli	a4,a4,0x20
ffffffffc0204878:	f0e697e3          	bne	a3,a4,ffffffffc0204786 <proc_init+0xa2>
ffffffffc020487c:	4798                	lw	a4,8(a5)
ffffffffc020487e:	f00714e3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc0204882:	6b98                	ld	a4,16(a5)
ffffffffc0204884:	f00711e3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
ffffffffc0204888:	4f98                	lw	a4,24(a5)
ffffffffc020488a:	2701                	sext.w	a4,a4
ffffffffc020488c:	ee071de3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
ffffffffc0204890:	7398                	ld	a4,32(a5)
ffffffffc0204892:	ee071ae3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204896:	7798                	ld	a4,40(a5)
ffffffffc0204898:	ee0717e3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
ffffffffc020489c:	0b07a703          	lw	a4,176(a5)
ffffffffc02048a0:	8d59                	or	a0,a0,a4
ffffffffc02048a2:	0005071b          	sext.w	a4,a0
ffffffffc02048a6:	ee0710e3          	bnez	a4,ffffffffc0204786 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02048aa:	00002517          	auipc	a0,0x2
ffffffffc02048ae:	48e50513          	addi	a0,a0,1166 # ffffffffc0206d38 <default_pmm_manager+0x1098>
ffffffffc02048b2:	8cffb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02048b6:	00093783          	ld	a5,0(s2)
ffffffffc02048ba:	b5f1                	j	ffffffffc0204786 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02048bc:	f2878793          	addi	a5,a5,-216
ffffffffc02048c0:	bfb9                	j	ffffffffc020481e <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02048c2:	00002617          	auipc	a2,0x2
ffffffffc02048c6:	45e60613          	addi	a2,a2,1118 # ffffffffc0206d20 <default_pmm_manager+0x1080>
ffffffffc02048ca:	19f00593          	li	a1,415
ffffffffc02048ce:	00002517          	auipc	a0,0x2
ffffffffc02048d2:	42250513          	addi	a0,a0,1058 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
ffffffffc02048d6:	b71fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048da:	00002617          	auipc	a2,0x2
ffffffffc02048de:	48e60613          	addi	a2,a2,1166 # ffffffffc0206d68 <default_pmm_manager+0x10c8>
ffffffffc02048e2:	1bf00593          	li	a1,447
ffffffffc02048e6:	00002517          	auipc	a0,0x2
ffffffffc02048ea:	40a50513          	addi	a0,a0,1034 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
ffffffffc02048ee:	b59fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048f2:	00002697          	auipc	a3,0x2
ffffffffc02048f6:	4c668693          	addi	a3,a3,1222 # ffffffffc0206db8 <default_pmm_manager+0x1118>
ffffffffc02048fa:	00001617          	auipc	a2,0x1
ffffffffc02048fe:	ff660613          	addi	a2,a2,-10 # ffffffffc02058f0 <commands+0x738>
ffffffffc0204902:	1c600593          	li	a1,454
ffffffffc0204906:	00002517          	auipc	a0,0x2
ffffffffc020490a:	3ea50513          	addi	a0,a0,1002 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
ffffffffc020490e:	b39fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204912:	00002697          	auipc	a3,0x2
ffffffffc0204916:	47e68693          	addi	a3,a3,1150 # ffffffffc0206d90 <default_pmm_manager+0x10f0>
ffffffffc020491a:	00001617          	auipc	a2,0x1
ffffffffc020491e:	fd660613          	addi	a2,a2,-42 # ffffffffc02058f0 <commands+0x738>
ffffffffc0204922:	1c500593          	li	a1,453
ffffffffc0204926:	00002517          	auipc	a0,0x2
ffffffffc020492a:	3ca50513          	addi	a0,a0,970 # ffffffffc0206cf0 <default_pmm_manager+0x1050>
ffffffffc020492e:	b19fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204932 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204932:	1141                	addi	sp,sp,-16
ffffffffc0204934:	e022                	sd	s0,0(sp)
ffffffffc0204936:	e406                	sd	ra,8(sp)
ffffffffc0204938:	00012417          	auipc	s0,0x12
ffffffffc020493c:	c7840413          	addi	s0,s0,-904 # ffffffffc02165b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0204940:	6018                	ld	a4,0(s0)
ffffffffc0204942:	4f1c                	lw	a5,24(a4)
ffffffffc0204944:	2781                	sext.w	a5,a5
ffffffffc0204946:	dff5                	beqz	a5,ffffffffc0204942 <cpu_idle+0x10>
            schedule();
ffffffffc0204948:	0a2000ef          	jal	ra,ffffffffc02049ea <schedule>
ffffffffc020494c:	bfd5                	j	ffffffffc0204940 <cpu_idle+0xe>

ffffffffc020494e <switch_to>:
.text
...
ffffffffc020494e:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204952:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204956:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204958:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020495a:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020495e:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204962:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204966:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020496a:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020496e:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204972:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204976:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020497a:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020497e:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204982:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204986:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc020498a:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc020498c:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020498e:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204992:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204996:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc020499a:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020499e:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02049a2:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02049a6:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02049aa:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02049ae:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02049b2:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02049b6:	8082                	ret

ffffffffc02049b8 <wakeup_proc>:
#include <assert.h>
...
ffffffffc02049b8:	411c                	lw	a5,0(a0)
ffffffffc02049ba:	4705                	li	a4,1
ffffffffc02049bc:	37f9                	addiw	a5,a5,-2
ffffffffc02049be:	00f77563          	bgeu	a4,a5,ffffffffc02049c8 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;    // 设置进程状态为可运行
ffffffffc02049c2:	4789                	li	a5,2
ffffffffc02049c4:	c11c                	sw	a5,0(a0)
ffffffffc02049c6:	8082                	ret
wakeup_proc(struct proc_struct *proc) {// 唤醒进程
ffffffffc02049c8:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE); // 断言进程不是僵尸进程或者可运行进程
ffffffffc02049ca:	00002697          	auipc	a3,0x2
ffffffffc02049ce:	41668693          	addi	a3,a3,1046 # ffffffffc0206de0 <default_pmm_manager+0x1140>
ffffffffc02049d2:	00001617          	auipc	a2,0x1
ffffffffc02049d6:	f1e60613          	addi	a2,a2,-226 # ffffffffc02058f0 <commands+0x738>
ffffffffc02049da:	45a9                	li	a1,10
ffffffffc02049dc:	00002517          	auipc	a0,0x2
ffffffffc02049e0:	44450513          	addi	a0,a0,1092 # ffffffffc0206e20 <default_pmm_manager+0x1180>
wakeup_proc(struct proc_struct *proc) {// 唤醒进程
ffffffffc02049e4:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE); // 断言进程不是僵尸进程或者可运行进程
ffffffffc02049e6:	a61fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049ea <schedule>:
}

void
schedule(void) {
ffffffffc02049ea:	1141                	addi	sp,sp,-16
ffffffffc02049ec:	e406                	sd	ra,8(sp)
ffffffffc02049ee:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049f0:	100027f3          	csrr	a5,sstatus
ffffffffc02049f4:	8b89                	andi	a5,a5,2
ffffffffc02049f6:	4401                	li	s0,0
ffffffffc02049f8:	efbd                	bnez	a5,ffffffffc0204a76 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049fa:	00012897          	auipc	a7,0x12
ffffffffc02049fe:	bb68b883          	ld	a7,-1098(a7) # ffffffffc02165b0 <current>
ffffffffc0204a02:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a06:	00012517          	auipc	a0,0x12
ffffffffc0204a0a:	bb253503          	ld	a0,-1102(a0) # ffffffffc02165b8 <idleproc>
ffffffffc0204a0e:	04a88e63          	beq	a7,a0,ffffffffc0204a6a <schedule+0x80>
ffffffffc0204a12:	0c888693          	addi	a3,a7,200
ffffffffc0204a16:	00012617          	auipc	a2,0x12
ffffffffc0204a1a:	b1260613          	addi	a2,a2,-1262 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc0204a1e:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc0204a20:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a22:	4809                	li	a6,2
ffffffffc0204a24:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a26:	00c78863          	beq	a5,a2,ffffffffc0204a36 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a2a:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a2e:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a32:	03070163          	beq	a4,a6,ffffffffc0204a54 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a36:	fef697e3          	bne	a3,a5,ffffffffc0204a24 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a3a:	ed89                	bnez	a1,ffffffffc0204a54 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a3c:	451c                	lw	a5,8(a0)
ffffffffc0204a3e:	2785                	addiw	a5,a5,1
ffffffffc0204a40:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a42:	00a88463          	beq	a7,a0,ffffffffc0204a4a <schedule+0x60>
            proc_run(next);
ffffffffc0204a46:	8dbff0ef          	jal	ra,ffffffffc0204320 <proc_run>
    if (flag) {
ffffffffc0204a4a:	e819                	bnez	s0,ffffffffc0204a60 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a4c:	60a2                	ld	ra,8(sp)
ffffffffc0204a4e:	6402                	ld	s0,0(sp)
ffffffffc0204a50:	0141                	addi	sp,sp,16
ffffffffc0204a52:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a54:	4198                	lw	a4,0(a1)
ffffffffc0204a56:	4789                	li	a5,2
ffffffffc0204a58:	fef712e3          	bne	a4,a5,ffffffffc0204a3c <schedule+0x52>
ffffffffc0204a5c:	852e                	mv	a0,a1
ffffffffc0204a5e:	bff9                	j	ffffffffc0204a3c <schedule+0x52>
}
ffffffffc0204a60:	6402                	ld	s0,0(sp)
ffffffffc0204a62:	60a2                	ld	ra,8(sp)
ffffffffc0204a64:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a66:	b57fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a6a:	00012617          	auipc	a2,0x12
ffffffffc0204a6e:	abe60613          	addi	a2,a2,-1346 # ffffffffc0216528 <proc_list>
ffffffffc0204a72:	86b2                	mv	a3,a2
ffffffffc0204a74:	b76d                	j	ffffffffc0204a1e <schedule+0x34>
        intr_disable();
ffffffffc0204a76:	b4dfb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a7a:	4405                	li	s0,1
ffffffffc0204a7c:	bfbd                	j	ffffffffc02049fa <schedule+0x10>

ffffffffc0204a7e <hash32>:
 *
...
ffffffffc0204a7e:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a82:	2785                	addiw	a5,a5,1
ffffffffc0204a84:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits)); // 取高位
ffffffffc0204a88:	02000793          	li	a5,32
ffffffffc0204a8c:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a8e:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a92:	8082                	ret

ffffffffc0204a94 <printnum>:
 * */
static void
...
ffffffffc0204a94:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a98:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a9a:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a9e:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204aa0:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204aa4:	f022                	sd	s0,32(sp)
ffffffffc0204aa6:	ec26                	sd	s1,24(sp)
ffffffffc0204aa8:	e84a                	sd	s2,16(sp)
ffffffffc0204aaa:	f406                	sd	ra,40(sp)
ffffffffc0204aac:	e44e                	sd	s3,8(sp)
ffffffffc0204aae:	84aa                	mv	s1,a0
ffffffffc0204ab0:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204ab2:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204ab6:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204ab8:	03067e63          	bgeu	a2,a6,ffffffffc0204af4 <printnum+0x60>
ffffffffc0204abc:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204abe:	00805763          	blez	s0,ffffffffc0204acc <printnum+0x38>
ffffffffc0204ac2:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204ac4:	85ca                	mv	a1,s2
ffffffffc0204ac6:	854e                	mv	a0,s3
ffffffffc0204ac8:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204aca:	fc65                	bnez	s0,ffffffffc0204ac2 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204acc:	1a02                	slli	s4,s4,0x20
ffffffffc0204ace:	00002797          	auipc	a5,0x2
ffffffffc0204ad2:	36a78793          	addi	a5,a5,874 # ffffffffc0206e38 <default_pmm_manager+0x1198>
ffffffffc0204ad6:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ada:	9a3e                	add	s4,s4,a5
}
ffffffffc0204adc:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ade:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204ae2:	70a2                	ld	ra,40(sp)
ffffffffc0204ae4:	69a2                	ld	s3,8(sp)
ffffffffc0204ae6:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ae8:	85ca                	mv	a1,s2
ffffffffc0204aea:	87a6                	mv	a5,s1
}
ffffffffc0204aec:	6942                	ld	s2,16(sp)
ffffffffc0204aee:	64e2                	ld	s1,24(sp)
ffffffffc0204af0:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204af2:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204af4:	03065633          	divu	a2,a2,a6
ffffffffc0204af8:	8722                	mv	a4,s0
ffffffffc0204afa:	f9bff0ef          	jal	ra,ffffffffc0204a94 <printnum>
ffffffffc0204afe:	b7f9                	j	ffffffffc0204acc <printnum+0x38>

ffffffffc0204b00 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204b00:	7119                	addi	sp,sp,-128
ffffffffc0204b02:	f4a6                	sd	s1,104(sp)
ffffffffc0204b04:	f0ca                	sd	s2,96(sp)
ffffffffc0204b06:	ecce                	sd	s3,88(sp)
ffffffffc0204b08:	e8d2                	sd	s4,80(sp)
ffffffffc0204b0a:	e4d6                	sd	s5,72(sp)
ffffffffc0204b0c:	e0da                	sd	s6,64(sp)
ffffffffc0204b0e:	fc5e                	sd	s7,56(sp)
ffffffffc0204b10:	f06a                	sd	s10,32(sp)
ffffffffc0204b12:	fc86                	sd	ra,120(sp)
ffffffffc0204b14:	f8a2                	sd	s0,112(sp)
ffffffffc0204b16:	f862                	sd	s8,48(sp)
ffffffffc0204b18:	f466                	sd	s9,40(sp)
ffffffffc0204b1a:	ec6e                	sd	s11,24(sp)
ffffffffc0204b1c:	892a                	mv	s2,a0
ffffffffc0204b1e:	84ae                	mv	s1,a1
ffffffffc0204b20:	8d32                	mv	s10,a2
ffffffffc0204b22:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204b24:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204b28:	5b7d                	li	s6,-1
ffffffffc0204b2a:	00002a97          	auipc	s5,0x2
ffffffffc0204b2e:	33aa8a93          	addi	s5,s5,826 # ffffffffc0206e64 <default_pmm_manager+0x11c4>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b32:	00002b97          	auipc	s7,0x2
ffffffffc0204b36:	50eb8b93          	addi	s7,s7,1294 # ffffffffc0207040 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b3a:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b3e:	001d0413          	addi	s0,s10,1
ffffffffc0204b42:	01350a63          	beq	a0,s3,ffffffffc0204b56 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b46:	c121                	beqz	a0,ffffffffc0204b86 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204b48:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b4a:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b4c:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b4e:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b52:	ff351ae3          	bne	a0,s3,ffffffffc0204b46 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b56:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b5a:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b5e:	4c81                	li	s9,0
ffffffffc0204b60:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b62:	5c7d                	li	s8,-1
ffffffffc0204b64:	5dfd                	li	s11,-1
ffffffffc0204b66:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b6a:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b6c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b70:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b74:	00140d13          	addi	s10,s0,1
ffffffffc0204b78:	04b56263          	bltu	a0,a1,ffffffffc0204bbc <vprintfmt+0xbc>
ffffffffc0204b7c:	058a                	slli	a1,a1,0x2
ffffffffc0204b7e:	95d6                	add	a1,a1,s5
ffffffffc0204b80:	4194                	lw	a3,0(a1)
ffffffffc0204b82:	96d6                	add	a3,a3,s5
ffffffffc0204b84:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b86:	70e6                	ld	ra,120(sp)
ffffffffc0204b88:	7446                	ld	s0,112(sp)
ffffffffc0204b8a:	74a6                	ld	s1,104(sp)
ffffffffc0204b8c:	7906                	ld	s2,96(sp)
ffffffffc0204b8e:	69e6                	ld	s3,88(sp)
ffffffffc0204b90:	6a46                	ld	s4,80(sp)
ffffffffc0204b92:	6aa6                	ld	s5,72(sp)
ffffffffc0204b94:	6b06                	ld	s6,64(sp)
ffffffffc0204b96:	7be2                	ld	s7,56(sp)
ffffffffc0204b98:	7c42                	ld	s8,48(sp)
ffffffffc0204b9a:	7ca2                	ld	s9,40(sp)
ffffffffc0204b9c:	7d02                	ld	s10,32(sp)
ffffffffc0204b9e:	6de2                	ld	s11,24(sp)
ffffffffc0204ba0:	6109                	addi	sp,sp,128
ffffffffc0204ba2:	8082                	ret
            padc = '0';
ffffffffc0204ba4:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204ba6:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204baa:	846a                	mv	s0,s10
ffffffffc0204bac:	00140d13          	addi	s10,s0,1
ffffffffc0204bb0:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204bb4:	0ff5f593          	zext.b	a1,a1
ffffffffc0204bb8:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b7c <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204bbc:	85a6                	mv	a1,s1
ffffffffc0204bbe:	02500513          	li	a0,37
ffffffffc0204bc2:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204bc4:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204bc8:	8d22                	mv	s10,s0
ffffffffc0204bca:	f73788e3          	beq	a5,s3,ffffffffc0204b3a <vprintfmt+0x3a>
ffffffffc0204bce:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bd2:	1d7d                	addi	s10,s10,-1
ffffffffc0204bd4:	ff379de3          	bne	a5,s3,ffffffffc0204bce <vprintfmt+0xce>
ffffffffc0204bd8:	b78d                	j	ffffffffc0204b3a <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bda:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bde:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be2:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204be4:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204be8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bec:	02d86463          	bltu	a6,a3,ffffffffc0204c14 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bf0:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bf4:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bf8:	0186873b          	addw	a4,a3,s8
ffffffffc0204bfc:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204c00:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204c02:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204c06:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204c08:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204c0c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204c10:	fed870e3          	bgeu	a6,a3,ffffffffc0204bf0 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204c14:	f40ddce3          	bgez	s11,ffffffffc0204b6c <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204c18:	8de2                	mv	s11,s8
ffffffffc0204c1a:	5c7d                	li	s8,-1
ffffffffc0204c1c:	bf81                	j	ffffffffc0204b6c <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204c1e:	fffdc693          	not	a3,s11
ffffffffc0204c22:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c24:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c28:	00144603          	lbu	a2,1(s0)
ffffffffc0204c2c:	2d81                	sext.w	s11,s11
ffffffffc0204c2e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c30:	bf35                	j	ffffffffc0204b6c <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c32:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c36:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c3a:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c3c:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c3e:	bfd9                	j	ffffffffc0204c14 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c40:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c42:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c46:	01174463          	blt	a4,a7,ffffffffc0204c4e <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c4a:	1a088e63          	beqz	a7,ffffffffc0204e06 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c4e:	000a3603          	ld	a2,0(s4)
ffffffffc0204c52:	46c1                	li	a3,16
ffffffffc0204c54:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c56:	2781                	sext.w	a5,a5
ffffffffc0204c58:	876e                	mv	a4,s11
ffffffffc0204c5a:	85a6                	mv	a1,s1
ffffffffc0204c5c:	854a                	mv	a0,s2
ffffffffc0204c5e:	e37ff0ef          	jal	ra,ffffffffc0204a94 <printnum>
            break;
ffffffffc0204c62:	bde1                	j	ffffffffc0204b3a <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c64:	000a2503          	lw	a0,0(s4)
ffffffffc0204c68:	85a6                	mv	a1,s1
ffffffffc0204c6a:	0a21                	addi	s4,s4,8
ffffffffc0204c6c:	9902                	jalr	s2
            break;
ffffffffc0204c6e:	b5f1                	j	ffffffffc0204b3a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c70:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c72:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c76:	01174463          	blt	a4,a7,ffffffffc0204c7e <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c7a:	18088163          	beqz	a7,ffffffffc0204dfc <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c7e:	000a3603          	ld	a2,0(s4)
ffffffffc0204c82:	46a9                	li	a3,10
ffffffffc0204c84:	8a2e                	mv	s4,a1
ffffffffc0204c86:	bfc1                	j	ffffffffc0204c56 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c88:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c8c:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c8e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c90:	bdf1                	j	ffffffffc0204b6c <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c92:	85a6                	mv	a1,s1
ffffffffc0204c94:	02500513          	li	a0,37
ffffffffc0204c98:	9902                	jalr	s2
            break;
ffffffffc0204c9a:	b545                	j	ffffffffc0204b3a <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c9c:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204ca0:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ca2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ca4:	b5e1                	j	ffffffffc0204b6c <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204ca6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204ca8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204cac:	01174463          	blt	a4,a7,ffffffffc0204cb4 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204cb0:	14088163          	beqz	a7,ffffffffc0204df2 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204cb4:	000a3603          	ld	a2,0(s4)
ffffffffc0204cb8:	46a1                	li	a3,8
ffffffffc0204cba:	8a2e                	mv	s4,a1
ffffffffc0204cbc:	bf69                	j	ffffffffc0204c56 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204cbe:	03000513          	li	a0,48
ffffffffc0204cc2:	85a6                	mv	a1,s1
ffffffffc0204cc4:	e03e                	sd	a5,0(sp)
ffffffffc0204cc6:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204cc8:	85a6                	mv	a1,s1
ffffffffc0204cca:	07800513          	li	a0,120
ffffffffc0204cce:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cd0:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cd2:	6782                	ld	a5,0(sp)
ffffffffc0204cd4:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cd6:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cda:	bfb5                	j	ffffffffc0204c56 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cdc:	000a3403          	ld	s0,0(s4)
ffffffffc0204ce0:	008a0713          	addi	a4,s4,8
ffffffffc0204ce4:	e03a                	sd	a4,0(sp)
ffffffffc0204ce6:	14040263          	beqz	s0,ffffffffc0204e2a <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cea:	0fb05763          	blez	s11,ffffffffc0204dd8 <vprintfmt+0x2d8>
ffffffffc0204cee:	02d00693          	li	a3,45
ffffffffc0204cf2:	0cd79163          	bne	a5,a3,ffffffffc0204db4 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cf6:	00044783          	lbu	a5,0(s0)
ffffffffc0204cfa:	0007851b          	sext.w	a0,a5
ffffffffc0204cfe:	cf85                	beqz	a5,ffffffffc0204d36 <vprintfmt+0x236>
ffffffffc0204d00:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d04:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d08:	000c4563          	bltz	s8,ffffffffc0204d12 <vprintfmt+0x212>
ffffffffc0204d0c:	3c7d                	addiw	s8,s8,-1
ffffffffc0204d0e:	036c0263          	beq	s8,s6,ffffffffc0204d32 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204d12:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d14:	0e0c8e63          	beqz	s9,ffffffffc0204e10 <vprintfmt+0x310>
ffffffffc0204d18:	3781                	addiw	a5,a5,-32
ffffffffc0204d1a:	0ef47b63          	bgeu	s0,a5,ffffffffc0204e10 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204d1e:	03f00513          	li	a0,63
ffffffffc0204d22:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d24:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d28:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d2a:	0a05                	addi	s4,s4,1
ffffffffc0204d2c:	0007851b          	sext.w	a0,a5
ffffffffc0204d30:	ffe1                	bnez	a5,ffffffffc0204d08 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d32:	01b05963          	blez	s11,ffffffffc0204d44 <vprintfmt+0x244>
ffffffffc0204d36:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204d38:	85a6                	mv	a1,s1
ffffffffc0204d3a:	02000513          	li	a0,32
ffffffffc0204d3e:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d40:	fe0d9be3          	bnez	s11,ffffffffc0204d36 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d44:	6a02                	ld	s4,0(sp)
ffffffffc0204d46:	bbd5                	j	ffffffffc0204b3a <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d48:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d4a:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d4e:	01174463          	blt	a4,a7,ffffffffc0204d56 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d52:	08088d63          	beqz	a7,ffffffffc0204dec <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d56:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d5a:	0a044d63          	bltz	s0,ffffffffc0204e14 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d5e:	8622                	mv	a2,s0
ffffffffc0204d60:	8a66                	mv	s4,s9
ffffffffc0204d62:	46a9                	li	a3,10
ffffffffc0204d64:	bdcd                	j	ffffffffc0204c56 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d66:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d6a:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d6c:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d6e:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d72:	8fb5                	xor	a5,a5,a3
ffffffffc0204d74:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d78:	02d74163          	blt	a4,a3,ffffffffc0204d9a <vprintfmt+0x29a>
ffffffffc0204d7c:	00369793          	slli	a5,a3,0x3
ffffffffc0204d80:	97de                	add	a5,a5,s7
ffffffffc0204d82:	639c                	ld	a5,0(a5)
ffffffffc0204d84:	cb99                	beqz	a5,ffffffffc0204d9a <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d86:	86be                	mv	a3,a5
ffffffffc0204d88:	00000617          	auipc	a2,0x0
ffffffffc0204d8c:	1f060613          	addi	a2,a2,496 # ffffffffc0204f78 <etext+0x2c>
ffffffffc0204d90:	85a6                	mv	a1,s1
ffffffffc0204d92:	854a                	mv	a0,s2
ffffffffc0204d94:	0ce000ef          	jal	ra,ffffffffc0204e62 <printfmt>
ffffffffc0204d98:	b34d                	j	ffffffffc0204b3a <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d9a:	00002617          	auipc	a2,0x2
ffffffffc0204d9e:	0be60613          	addi	a2,a2,190 # ffffffffc0206e58 <default_pmm_manager+0x11b8>
ffffffffc0204da2:	85a6                	mv	a1,s1
ffffffffc0204da4:	854a                	mv	a0,s2
ffffffffc0204da6:	0bc000ef          	jal	ra,ffffffffc0204e62 <printfmt>
ffffffffc0204daa:	bb41                	j	ffffffffc0204b3a <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204dac:	00002417          	auipc	s0,0x2
ffffffffc0204db0:	0a440413          	addi	s0,s0,164 # ffffffffc0206e50 <default_pmm_manager+0x11b0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204db4:	85e2                	mv	a1,s8
ffffffffc0204db6:	8522                	mv	a0,s0
ffffffffc0204db8:	e43e                	sd	a5,8(sp)
ffffffffc0204dba:	0e2000ef          	jal	ra,ffffffffc0204e9c <strnlen>
ffffffffc0204dbe:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204dc2:	01b05b63          	blez	s11,ffffffffc0204dd8 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204dc6:	67a2                	ld	a5,8(sp)
ffffffffc0204dc8:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dcc:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204dce:	85a6                	mv	a1,s1
ffffffffc0204dd0:	8552                	mv	a0,s4
ffffffffc0204dd2:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204dd4:	fe0d9ce3          	bnez	s11,ffffffffc0204dcc <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dd8:	00044783          	lbu	a5,0(s0)
ffffffffc0204ddc:	00140a13          	addi	s4,s0,1
ffffffffc0204de0:	0007851b          	sext.w	a0,a5
ffffffffc0204de4:	d3a5                	beqz	a5,ffffffffc0204d44 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204de6:	05e00413          	li	s0,94
ffffffffc0204dea:	bf39                	j	ffffffffc0204d08 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dec:	000a2403          	lw	s0,0(s4)
ffffffffc0204df0:	b7ad                	j	ffffffffc0204d5a <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204df2:	000a6603          	lwu	a2,0(s4)
ffffffffc0204df6:	46a1                	li	a3,8
ffffffffc0204df8:	8a2e                	mv	s4,a1
ffffffffc0204dfa:	bdb1                	j	ffffffffc0204c56 <vprintfmt+0x156>
ffffffffc0204dfc:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e00:	46a9                	li	a3,10
ffffffffc0204e02:	8a2e                	mv	s4,a1
ffffffffc0204e04:	bd89                	j	ffffffffc0204c56 <vprintfmt+0x156>
ffffffffc0204e06:	000a6603          	lwu	a2,0(s4)
ffffffffc0204e0a:	46c1                	li	a3,16
ffffffffc0204e0c:	8a2e                	mv	s4,a1
ffffffffc0204e0e:	b5a1                	j	ffffffffc0204c56 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204e10:	9902                	jalr	s2
ffffffffc0204e12:	bf09                	j	ffffffffc0204d24 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204e14:	85a6                	mv	a1,s1
ffffffffc0204e16:	02d00513          	li	a0,45
ffffffffc0204e1a:	e03e                	sd	a5,0(sp)
ffffffffc0204e1c:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204e1e:	6782                	ld	a5,0(sp)
ffffffffc0204e20:	8a66                	mv	s4,s9
ffffffffc0204e22:	40800633          	neg	a2,s0
ffffffffc0204e26:	46a9                	li	a3,10
ffffffffc0204e28:	b53d                	j	ffffffffc0204c56 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e2a:	03b05163          	blez	s11,ffffffffc0204e4c <vprintfmt+0x34c>
ffffffffc0204e2e:	02d00693          	li	a3,45
ffffffffc0204e32:	f6d79de3          	bne	a5,a3,ffffffffc0204dac <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e36:	00002417          	auipc	s0,0x2
ffffffffc0204e3a:	01a40413          	addi	s0,s0,26 # ffffffffc0206e50 <default_pmm_manager+0x11b0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e3e:	02800793          	li	a5,40
ffffffffc0204e42:	02800513          	li	a0,40
ffffffffc0204e46:	00140a13          	addi	s4,s0,1
ffffffffc0204e4a:	bd6d                	j	ffffffffc0204d04 <vprintfmt+0x204>
ffffffffc0204e4c:	00002a17          	auipc	s4,0x2
ffffffffc0204e50:	005a0a13          	addi	s4,s4,5 # ffffffffc0206e51 <default_pmm_manager+0x11b1>
ffffffffc0204e54:	02800513          	li	a0,40
ffffffffc0204e58:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e5c:	05e00413          	li	s0,94
ffffffffc0204e60:	b565                	j	ffffffffc0204d08 <vprintfmt+0x208>

ffffffffc0204e62 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e62:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e64:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e68:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e6a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e6c:	ec06                	sd	ra,24(sp)
ffffffffc0204e6e:	f83a                	sd	a4,48(sp)
ffffffffc0204e70:	fc3e                	sd	a5,56(sp)
ffffffffc0204e72:	e0c2                	sd	a6,64(sp)
ffffffffc0204e74:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e76:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e78:	c89ff0ef          	jal	ra,ffffffffc0204b00 <vprintfmt>
}
ffffffffc0204e7c:	60e2                	ld	ra,24(sp)
ffffffffc0204e7e:	6161                	addi	sp,sp,80
ffffffffc0204e80:	8082                	ret

ffffffffc0204e82 <strlen>:
...
strlen(const char *s) {
ffffffffc0204e86:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e88:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e8a:	cb81                	beqz	a5,ffffffffc0204e9a <strlen+0x18>
        cnt ++;
ffffffffc0204e8c:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e8e:	00a707b3          	add	a5,a4,a0
ffffffffc0204e92:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e96:	fbfd                	bnez	a5,ffffffffc0204e8c <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e9c:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e9e:	e589                	bnez	a1,ffffffffc0204ea8 <strnlen+0xc>
ffffffffc0204ea0:	a811                	j	ffffffffc0204eb4 <strnlen+0x18>
        cnt ++;
ffffffffc0204ea2:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204ea4:	00f58863          	beq	a1,a5,ffffffffc0204eb4 <strnlen+0x18>
ffffffffc0204ea8:	00f50733          	add	a4,a0,a5
ffffffffc0204eac:	00074703          	lbu	a4,0(a4)
ffffffffc0204eb0:	fb6d                	bnez	a4,ffffffffc0204ea2 <strnlen+0x6>
ffffffffc0204eb2:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204eb4:	852e                	mv	a0,a1
ffffffffc0204eb6:	8082                	ret

ffffffffc0204eb8 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204eb8:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204eba:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ebe:	0785                	addi	a5,a5,1
ffffffffc0204ec0:	0585                	addi	a1,a1,1
ffffffffc0204ec2:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204ec6:	fb75                	bnez	a4,ffffffffc0204eba <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204ece:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ed2:	cb89                	beqz	a5,ffffffffc0204ee4 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204ed4:	0505                	addi	a0,a0,1
ffffffffc0204ed6:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204ed8:	fee789e3          	beq	a5,a4,ffffffffc0204eca <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204edc:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ee0:	9d19                	subw	a0,a0,a4
ffffffffc0204ee2:	8082                	ret
ffffffffc0204ee4:	4501                	li	a0,0
ffffffffc0204ee6:	bfed                	j	ffffffffc0204ee0 <strcmp+0x16>

ffffffffc0204ee8 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204ee8:	00054783          	lbu	a5,0(a0)
ffffffffc0204eec:	c799                	beqz	a5,ffffffffc0204efa <strchr+0x12>
        if (*s == c) {
ffffffffc0204eee:	00f58763          	beq	a1,a5,ffffffffc0204efc <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ef2:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204ef6:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204ef8:	fbfd                	bnez	a5,ffffffffc0204eee <strchr+0x6>
    }
    return NULL;
ffffffffc0204efa:	4501                	li	a0,0
}
ffffffffc0204efc:	8082                	ret

ffffffffc0204efe <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204efe:	ca01                	beqz	a2,ffffffffc0204f0e <memset+0x10>
ffffffffc0204f00:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204f02:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204f04:	0785                	addi	a5,a5,1
ffffffffc0204f06:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204f0a:	fec79de3          	bne	a5,a2,ffffffffc0204f04 <memset+0x6>
    }
    return s;
...
ffffffffc0204f10 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204f10:	ca19                	beqz	a2,ffffffffc0204f26 <memcpy+0x16>
ffffffffc0204f12:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204f14:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204f16:	0005c703          	lbu	a4,0(a1)
ffffffffc0204f1a:	0585                	addi	a1,a1,1
ffffffffc0204f1c:	0785                	addi	a5,a5,1
ffffffffc0204f1e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204f22:	fec59ae3          	bne	a1,a2,ffffffffc0204f16 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f28:	c205                	beqz	a2,ffffffffc0204f48 <memcmp+0x20>
ffffffffc0204f2a:	962e                	add	a2,a2,a1
ffffffffc0204f2c:	a019                	j	ffffffffc0204f32 <memcmp+0xa>
ffffffffc0204f2e:	00c58d63          	beq	a1,a2,ffffffffc0204f48 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204f32:	00054783          	lbu	a5,0(a0)
ffffffffc0204f36:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204f3a:	0505                	addi	a0,a0,1
ffffffffc0204f3c:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f3e:	fee788e3          	beq	a5,a4,ffffffffc0204f2e <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f42:	40e7853b          	subw	a0,a5,a4
ffffffffc0204f46:	8082                	ret
    }
    return 0;
ffffffffc0204f48:	4501                	li	a0,0
}
